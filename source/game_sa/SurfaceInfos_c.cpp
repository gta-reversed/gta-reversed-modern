...
{
    Install("SurfaceInfos_c", "GetSurfaceIdFromName", 0x55D220, &SurfaceInfos_c::GetSurfaceIdFromName);
    Install("SurfaceInfos_c", "Init", 0x55F420, &SurfaceInfos_c::Init);

    Install("SurfaceInfos_c", "GetAdhesionGroup", 0x55E5C0, &SurfaceInfos_c::GetAdhesionGroup);
    Install("SurfaceInfos_c", "GetTyreGrip", 0x55E5E0, &SurfaceInfos_c::GetTyreGrip);
    Install("SurfaceInfos_c", "GetWetMultiplier", 0x55E600, &SurfaceInfos_c::GetWetMultiplier);
    Install("SurfaceInfos_c", "GetSkidmarkType", 0x55E630, &SurfaceInfos_c::GetSkidmarkType);
    Install("SurfaceInfos_c", "GetFrictionEffect", 0x55E650, &SurfaceInfos_c::GetFrictionEffect);
    Install("SurfaceInfos_c", "GetBulletFx", 0x55E670, &SurfaceInfos_c::GetBulletFx);
    Install("SurfaceInfos_c", "IsSoftLanding", 0x55E690, &SurfaceInfos_c::IsSoftLanding);
    Install("SurfaceInfos_c", "IsSeeThrough", 0x55E6B0, &SurfaceInfos_c::IsSeeThrough);
    Install("SurfaceInfos_c", "IsShootThrough", 0x55E6D0, &SurfaceInfos_c::IsShootThrough);
    Install("SurfaceInfos_c", "IsSand", 0x55E6F0, &SurfaceInfos_c::IsSand);
    Install("SurfaceInfos_c", "IsWater", 0x55E710, &SurfaceInfos_c::IsWater);
    Install("SurfaceInfos_c", "IsShallowWater", 0x55E730, &SurfaceInfos_c::IsShallowWater);
    Install("SurfaceInfos_c", "IsBeach", 0x55E750, &SurfaceInfos_c::IsBeach);
    Install("SurfaceInfos_c", "IsSteepSlope", 0x55E770, &SurfaceInfos_c::IsSteepSlope);
    Install("SurfaceInfos_c", "IsGlass", 0x55E790, &SurfaceInfos_c::IsGlass);
    Install("SurfaceInfos_c", "IsStairs", 0x55E7B0, &SurfaceInfos_c::IsStairs);
    Install("SurfaceInfos_c", "IsSkateable", 0x55E7D0, &SurfaceInfos_c::IsSkateable);
    Install("SurfaceInfos_c", "IsPavement", 0x55E7F0, &SurfaceInfos_c::IsPavement);
    Install("SurfaceInfos_c", "GetRoughness", 0x55E810, &SurfaceInfos_c::GetRoughness);
    Install("SurfaceInfos_c", "GetFlammability", 0x55E830, &SurfaceInfos_c::GetFlammability);
    Install("SurfaceInfos_c", "CreatesSparks", 0x55E850, &SurfaceInfos_c::CreatesSparks);
    Install("SurfaceInfos_c", "CantSprintOn", 0x55E870, &SurfaceInfos_c::CantSprintOn);
    Install("SurfaceInfos_c", "LeavesFootsteps", 0x55E890, &SurfaceInfos_c::LeavesFootsteps);
    Install("SurfaceInfos_c", "ProducesFootDust", 0x55E8B0, &SurfaceInfos_c::ProducesFootDust);
    Install("SurfaceInfos_c", "MakesCarDirty", 0x55E8D0, &SurfaceInfos_c::MakesCarDirty);
    Install("SurfaceInfos_c", "MakesCarClean", 0x55E8F0, &SurfaceInfos_c::MakesCarClean);
    Install("SurfaceInfos_c", "CreatesWheelGrass", 0x55E910, &SurfaceInfos_c::CreatesWheelGrass);
    Install("SurfaceInfos_c", "CreatesWheelGravel", 0x55E930, &SurfaceInfos_c::CreatesWheelGravel);
    Install("SurfaceInfos_c", "CreatesWheelMud", 0x55E950, &SurfaceInfos_c::CreatesWheelMud);
    Install("SurfaceInfos_c", "CreatesWheelDust", 0x55E970, &SurfaceInfos_c::CreatesWheelDust);
    Install("SurfaceInfos_c", "CreatesWheelSand", 0x55E990, &SurfaceInfos_c::CreatesWheelSand);
    Install("SurfaceInfos_c", "CreatesWheelSpray", 0x55E9B0, &SurfaceInfos_c::CreatesWheelSpray);
    Install("SurfaceInfos_c", "CreatesPlants", 0x55E9D0, &SurfaceInfos_c::CreatesPlants);
    Install("SurfaceInfos_c", "CreatesObjects", 0x55E9F0, &SurfaceInfos_c::CreatesObjects);
    Install("SurfaceInfos_c", "CanClimb", 0x55EA10, &SurfaceInfos_c::CanClimb);
    Install("SurfaceInfos_c", "IsAudioConcrete", 0x55EA30, &SurfaceInfos_c::IsAudioConcrete);
    Install("SurfaceInfos_c", "IsAudioGrass", 0x55EA50, &SurfaceInfos_c::IsAudioGrass);
    Install("SurfaceInfos_c", "IsAudioSand", 0x55EA70, &SurfaceInfos_c::IsAudioSand);
    Install("SurfaceInfos_c", "IsAudioGravel", 0x55EA90, &SurfaceInfos_c::IsAudioGravel);
    Install("SurfaceInfos_c", "IsAudioWood", 0x55EAB0, &SurfaceInfos_c::IsAudioWood);
    Install("SurfaceInfos_c", "IsAudioWater", 0x55EAD0, &SurfaceInfos_c::IsAudioWater);
    Install("SurfaceInfos_c", "IsAudioMetal", 0x55EAF0, &SurfaceInfos_c::IsAudioMetal);
    Install("SurfaceInfos_c", "IsAudioLongGrass", 0x55EB10, &SurfaceInfos_c::IsAudioLongGrass);
    Install("SurfaceInfos_c", "IsAudioTile", 0x55EB30, &SurfaceInfos_c::IsAudioTile);
    Install("SurfaceInfos_c", "GetAdhesiveLimit", 0x55EB50, &SurfaceInfos_c::GetAdhesiveLimit);
}
