...
void SurfaceInfos_c::InjectHooks()
{
    ...
    ReversibleHooks::Install("SurfaceInfos_c", "GetAdhesionGroup", 0x55E5C0, &SurfaceInfos_c::GetAdhesionGroup);
    ReversibleHooks::Install("SurfaceInfos_c", "GetTyreGrip", 0x55E5E0, &SurfaceInfos_c::GetTyreGrip);
    ReversibleHooks::Install("SurfaceInfos_c", "GetWetMultiplier", 0x55E600, &SurfaceInfos_c::GetWetMultiplier);
    ReversibleHooks::Install("SurfaceInfos_c", "GetSkidmarkType", 0x55E630, &SurfaceInfos_c::GetSkidmarkType);
    ReversibleHooks::Install("SurfaceInfos_c", "GetFrictionEffect", 0x55E650, &SurfaceInfos_c::GetFrictionEffect);
    ReversibleHooks::Install("SurfaceInfos_c", "GetBulletFx", 0x55E670, &SurfaceInfos_c::GetBulletFx);
    ReversibleHooks::Install("SurfaceInfos_c", "IsSoftLanding", 0x55E690, &SurfaceInfos_c::IsSoftLanding);
    ReversibleHooks::Install("SurfaceInfos_c", "IsSeeThrough", 0x55E6B0, &SurfaceInfos_c::IsSeeThrough);
    ReversibleHooks::Install("SurfaceInfos_c", "IsShootThrough", 0x55E6D0, &SurfaceInfos_c::IsShootThrough);
    ReversibleHooks::Install("SurfaceInfos_c", "IsSand", 0x55E6F0, &SurfaceInfos_c::IsSand);
    ReversibleHooks::Install("SurfaceInfos_c", "IsWater", 0x55E710, &SurfaceInfos_c::IsWater);
    ReversibleHooks::Install("SurfaceInfos_c", "IsShallowWater", 0x55E730, &SurfaceInfos_c::IsShallowWater);
    ReversibleHooks::Install("SurfaceInfos_c", "IsBeach", 0x55E750, &SurfaceInfos_c::IsBeach);
    ReversibleHooks::Install("SurfaceInfos_c", "IsSteepSlope", 0x55E770, &SurfaceInfos_c::IsSteepSlope);
    ReversibleHooks::Install("SurfaceInfos_c", "IsGlass", 0x55E790, &SurfaceInfos_c::IsGlass);
    ReversibleHooks::Install("SurfaceInfos_c", "IsStairs", 0x55E7B0, &SurfaceInfos_c::IsStairs);
    ReversibleHooks::Install("SurfaceInfos_c", "IsSkateable", 0x55E7D0, &SurfaceInfos_c::IsSkateable);
    ReversibleHooks::Install("SurfaceInfos_c", "IsPavement", 0x55E7F0, &SurfaceInfos_c::IsPavement);
    ReversibleHooks::Install("SurfaceInfos_c", "GetRoughness", 0x55E810, &SurfaceInfos_c::GetRoughness);
    ReversibleHooks::Install("SurfaceInfos_c", "GetFlammability", 0x55E830, &SurfaceInfos_c::GetFlammability);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesSparks", 0x55E850, &SurfaceInfos_c::CreatesSparks);
    ReversibleHooks::Install("SurfaceInfos_c", "CantSprintOn", 0x55E870, &SurfaceInfos_c::CantSprintOn);
    ReversibleHooks::Install("SurfaceInfos_c", "LeavesFootsteps", 0x55E890, &SurfaceInfos_c::LeavesFootsteps);
    ReversibleHooks::Install("SurfaceInfos_c", "ProducesFootDust", 0x55E8B0, &SurfaceInfos_c::ProducesFootDust);
    ReversibleHooks::Install("SurfaceInfos_c", "MakesCarDirty", 0x55E8D0, &SurfaceInfos_c::MakesCarDirty);
    ReversibleHooks::Install("SurfaceInfos_c", "MakesCarClean", 0x55E8F0, &SurfaceInfos_c::MakesCarClean);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesWheelGrass", 0x55E910, &SurfaceInfos_c::CreatesWheelGrass);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesWheelGravel", 0x55E930, &SurfaceInfos_c::CreatesWheelGravel);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesWheelMud", 0x55E950, &SurfaceInfos_c::CreatesWheelMud);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesWheelDust", 0x55E970, &SurfaceInfos_c::CreatesWheelDust);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesWheelSand", 0x55E990, &SurfaceInfos_c::CreatesWheelSand);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesWheelSpray", 0x55E9B0, &SurfaceInfos_c::CreatesWheelSpray);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesPlants", 0x55E9D0, &SurfaceInfos_c::CreatesPlants);
    ReversibleHooks::Install("SurfaceInfos_c", "CreatesObjects", 0x55E9F0, &SurfaceInfos_c::CreatesObjects);
    ReversibleHooks::Install("SurfaceInfos_c", "CanClimb", 0x55EA10, &SurfaceInfos_c::CanClimb);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioConcrete", 0x55EA30, &SurfaceInfos_c::IsAudioConcrete);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioGrass", 0x55EA50, &SurfaceInfos_c::IsAudioGrass);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioSand", 0x55EA70, &SurfaceInfos_c::IsAudioSand);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioGravel", 0x55EA90, &SurfaceInfos_c::IsAudioGravel);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioWood", 0x55EAB0, &SurfaceInfos_c::IsAudioWood);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioWater", 0x55EAD0, &SurfaceInfos_c::IsAudioWater);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioMetal", 0x55EAF0, &SurfaceInfos_c::IsAudioMetal);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioLongGrass", 0x55EB10, &SurfaceInfos_c::IsAudioLongGrass);
    ReversibleHooks::Install("SurfaceInfos_c", "IsAudioTile", 0x55EB30, &SurfaceInfos_c::IsAudioTile);
    ReversibleHooks::Install("SurfaceInfos_c", "GetAdhesiveLimit", 0x55EB50, &SurfaceInfos_c::GetAdhesiveLimit);
}
