...
void CKeyGen::InjectHooks() {
    ...
    Install("CKeyGen", "GetKey", 0x53CF00, static_cast<uint32(*)(const char*)>(CKeyGen::GetKey));
    Install("CKeyGen", "GetKey_size", 0x53CED0, static_cast<uint32(*)(const char*, int32)>(CKeyGen::GetKey));
