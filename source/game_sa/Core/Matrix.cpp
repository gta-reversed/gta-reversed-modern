...
{
    Install("CMatrix", "Attach", 0x59BD10, &CMatrix::Attach);
    Install("CMatrix", "Detach", 0x59ACF0, &CMatrix::Detach);
    Install("CMatrix", "CopyOnlyMatrix", 0x59ADD0, &CMatrix::CopyOnlyMatrix);
    Install("CMatrix", "Update", 0x59BB60, &CMatrix::Update);
    Install("CMatrix", "UpdateMatrix", 0x59AD20, &CMatrix::UpdateMatrix);
    Install("CMatrix", "UpdateRW", 0x59BBB0, &CMatrix::UpdateRW);
    ...
    Install("CMatrix", "SetRotateYOnly", 0x59AFE0, &CMatrix::SetRotateYOnly);
    Install("CMatrix", "SetRotateZOnly", 0x59B020, &CMatrix::SetRotateZOnly);
    ...
    Install("CMatrix", "ConvertFromEulerAngles", 0x59AA40, &CMatrix::ConvertFromEulerAngles);
