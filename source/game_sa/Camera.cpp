...
void CCamera::InjectHooks() {
    Install("CCamera", "GetArrPosForVehicleType", 0x50AF00, &CCamera::GetArrPosForVehicleType);
    Install("CCamera", "GetPositionAlongSpline", 0x50AF80, &CCamera::GetPositionAlongSpline);
    Install("CCamera", "InitialiseCameraForDebugMode", 0x50AF90, &CCamera::InitialiseCameraForDebugMode);
    Install("CCamera", "ProcessObbeCinemaCameraPed", 0x50B880, &CCamera::ProcessObbeCinemaCameraPed);
    Install("CCamera", "ProcessWideScreenOn", 0x50B890, &CCamera::ProcessWideScreenOn);
    Install("CCamera", "RenderMotionBlur", 0x50B8F0, &CCamera::RenderMotionBlur);
    Install("CCamera", "SetCameraDirectlyBehindForFollowPed_CamOnAString", 0x50BD40, &CCamera::SetCameraDirectlyBehindForFollowPed_CamOnAString);
    Install("CCamera", "SetCameraDirectlyInFrontForFollowPed_CamOnAString", 0x50BD70, &CCamera::SetCameraDirectlyInFrontForFollowPed_CamOnAString);
    Install("CCamera", "SetCamPositionForFixedMode", 0x50BEC0, &CCamera::SetCamPositionForFixedMode);
    Install("CCamera", "SetFadeColour", 0x50BF00, &CCamera::SetFadeColour);
    Install("CCamera", "SetMotionBlur", 0x50BF40, &CCamera::SetMotionBlur);
    Install("CCamera", "SetMotionBlurAlpha", 0x50BF80, &CCamera::SetMotionBlurAlpha);
    Install("CCamera", "SetNearClipScript", 0x50BF90, &CCamera::SetNearClipScript);
    Install("CCamera", "SetNewPlayerWeaponMode", 0x50BFB0, &CCamera::SetNewPlayerWeaponMode);
    Install("CCamera", "SetRwCamera", 0x50C100, &CCamera::SetRwCamera);
    Install("CCamera", "SetWideScreenOn", 0x50C140, &CCamera::SetWideScreenOn);
    Install("CCamera", "SetWideScreenOff", 0x50C150, &CCamera::SetWideScreenOff);
    Install("CCamera", "StartCooperativeCamMode", 0x50C260, &CCamera::StartCooperativeCamMode);
    Install("CCamera", "StopCooperativeCamMode", 0x50C270, &CCamera::StopCooperativeCamMode);
    Install("CCamera", "AllowShootingWith2PlayersInCar", 0x50C280, &CCamera::AllowShootingWith2PlayersInCar);
    Install("CCamera", "StoreValuesDuringInterPol", 0x50C290, &CCamera::StoreValuesDuringInterPol);
    Install("CCamera", "ProcessScriptedCommands", 0x516AE0, &CCamera::ProcessScriptedCommands);
    Install("CCamera", "FinishCutscene", 0x514950, &CCamera::FinishCutscene);
    Install("CCamera", "LerpFOV", 0x50D280, &CCamera::LerpFOV);
    Install("CCamera", "UpdateAimingCoors", 0x50CB10, &CCamera::UpdateAimingCoors);
    Install("CCamera", "SetColVarsAimWeapon", 0x50CBF0, &CCamera::SetColVarsAimWeapon);
    Install("CCamera", "ClearPlayerWeaponMode", 0x50AB10, &CCamera::ClearPlayerWeaponMode);
    Install("CCamera", "DontProcessObbeCinemaCamera", 0x50AB40, &CCamera::DontProcessObbeCinemaCamera);
    Install("CCamera", "Enable1rstPersonCamCntrlsScript", 0x50AC00, &CCamera::Enable1rstPersonCamCntrlsScript);
    Install("CCamera", "FindCamFOV", 0x50AD20, &CCamera::FindCamFOV);
    Install("CCamera", "GetFading", 0x50ADE0, &CCamera::GetFading);
    Install("CCamera", "GetFadingDirection", 0x50ADF0, &CCamera::GetFadingDirection);
    Install("CCamera", "Get_Just_Switched_Status", 0x50AE10, &CCamera::Get_Just_Switched_Status);
    Install("CCamera", "GetGameCamPosition", 0x50AE50, &CCamera::GetGameCamPosition);

//    Install("CCamera", "Constructor", 0x51A450, &CCamera::Constructor);
//    Install("CCamera", "Destructor", 0x50A870, &CCamera::Destructor);
//    Install("CCamera", "InitCameraVehicleTweaks", 0x50A3B0, &CCamera::InitCameraVehicleTweaks);
//    Install("CCamera", "ApplyVehicleCameraTweaks", 0x50A480, &CCamera::ApplyVehicleCameraTweaks);
//    Install("CCamera", "CamShake", 0x50A9F0, &CCamera::CamShake);
//    Install("CCamera", "GetScreenRect", 0x50AB50, &CCamera::GetScreenRect);
//    Install("CCamera", "Enable1rstPersonWeaponsCamera", 0x50AC10, &CCamera::Enable1rstPersonWeaponsCamera);
//    Install("CCamera", "Fade", 0x50AC20, &CCamera::Fade);
//    Install("CCamera", "Find3rdPersonQuickAimPitch", 0x50AD40, &CCamera::Find3rdPersonQuickAimPitch);
//    Install("CCamera", "GetCutSceneFinishTime", 0x50AD90, &CCamera::GetCutSceneFinishTime);
//    Install("CCamera", "GetScreenFadeStatus", 0x50AE20, &CCamera::GetScreenFadeStatus);
//    Install("CCamera", "GetLookingLRBFirstPerson", 0x50AE60, &CCamera::GetLookingLRBFirstPerson);
//    Install("CCamera", "GetLookDirection", 0x50AE90, &CCamera::GetLookDirection);
//    Install("CCamera", "GetLookingForwardFirstPerson", 0x50AED0, &CCamera::GetLookingForwardFirstPerson);
//    Install("CCamera", "CopyCameraMatrixToRWCam", 0x50AFA0, &CCamera::CopyCameraMatrixToRWCam);
    Install("CCamera", "CalculateMirroredMatrix", 0x50B380, &CCamera::CalculateMirroredMatrix);
    Install("CCamera", "DealWithMirrorBeforeConstructRenderList", 0x50B510, &CCamera::DealWithMirrorBeforeConstructRenderList);
//    Install("CCamera", "ProcessFade", 0x50B5D0, &CCamera::ProcessFade);
//    Install("CCamera", "ProcessMusicFade", 0x50B6D0, &CCamera::ProcessMusicFade);
//    Install("CCamera", "Restore", 0x50B930, &CCamera::Restore);
//    Install("CCamera", "RestoreWithJumpCut", 0x50BAB0, &CCamera::RestoreWithJumpCut);
//    Install("CCamera", "SetCamCutSceneOffSet", 0x50BD20, &CCamera::SetCamCutSceneOffSet);
//    Install("CCamera", "SetCameraDirectlyBehindForFollowPed_ForAPed_CamOnAString", 0x50BDA0, &CCamera::SetCameraDirectlyBehindForFollowPed_ForAPed_CamOnAString);
//    Install("CCamera", "SetCameraDirectlyInFrontForFollowPed_ForAPed_CamOnAString", 0x50BE30, &CCamera::SetCameraDirectlyInFrontForFollowPed_ForAPed_CamOnAString);
//    Install("CCamera", "Using1stPersonWeaponMode", 0x50BFF0, &CCamera::Using1stPersonWeaponMode);
    Install("CCamera", "SetParametersForScriptInterpolation", 0x50C030, &CCamera::SetParametersForScriptInterpolation);
//    Install("CCamera", "SetPercentAlongCutScene", 0x50C070, &CCamera::SetPercentAlongCutScene);
//    Install("CCamera", "SetZoomValueFollowPedScript", 0x50C160, &CCamera::SetZoomValueFollowPedScript);
//    Install("CCamera", "SetZoomValueCamStringScript", 0x50C1B0, &CCamera::SetZoomValueCamStringScript);
//    Install("CCamera", "UpdateTargetEntity", 0x50C360, &CCamera::UpdateTargetEntity);
//    Install("CCamera", "TakeControl", 0x50C7C0, &CCamera::TakeControl);
//    Install("CCamera", "TakeControlNoEntity", 0x50C8B0, &CCamera::TakeControlNoEntity);
//    Install("CCamera", "TakeControlAttachToEntity", 0x50C910, &CCamera::TakeControlAttachToEntity);
    Install("CCamera", "TakeControlWithSpline", 0x50CAE0, &CCamera::TakeControlWithSpline);
//    Install("CCamera", "SetCamCollisionVarDataSet", 0x50CB60, &CCamera::SetCamCollisionVarDataSet);
//    Install("CCamera", "SetNearClipBasedOnPedCollision", 0x50CB90, &CCamera::SetNearClipBasedOnPedCollision);
//    Install("CCamera", "SetColVarsPed", 0x50CC50, &CCamera::SetColVarsPed);
//    Install("CCamera", "SetColVarsVehicle", 0x50CCA0, &CCamera::SetColVarsVehicle);
//    Install("CCamera", "CameraGenericModeSpecialCases", 0x50CD30, &CCamera::CameraGenericModeSpecialCases);
//    Install("CCamera", "CameraPedModeSpecialCases", 0x50CD80, &CCamera::CameraPedModeSpecialCases);
//    Install("CCamera", "CameraPedAimModeSpecialCases", 0x50CDA0, &CCamera::CameraPedAimModeSpecialCases);
//    Install("CCamera", "CameraVehicleModeSpecialCases", 0x50CDE0, &CCamera::CameraVehicleModeSpecialCases);
//    Install("CCamera", "IsExtraEntityToIgnore", 0x50CE80, &CCamera::IsExtraEntityToIgnore);
//    Install("CCamera", "ConsiderPedAsDucking", 0x50CEB0, &CCamera::ConsiderPedAsDucking);
//    Install("CCamera", "ResetDuckingSystem", 0x50CEF0, &CCamera::ResetDuckingSystem);
//    Install("CCamera", "HandleCameraMotionForDucking", 0x50CFA0, &CCamera::HandleCameraMotionForDucking);
//    Install("CCamera", "HandleCameraMotionForDuckingDuringAim", 0x50D090, &CCamera::HandleCameraMotionForDuckingDuringAim);
//    Install("CCamera", "VectorMoveLinear", 0x50D160, &CCamera::VectorMoveLinear);
//    Install("CCamera", "VectorTrackLinear", 0x50D1D0, &CCamera::VectorTrackLinear);
//    Install("CCamera", "AddShakeSimple", 0x50D240, &CCamera::AddShakeSimple);
//    Install("CCamera", "InitialiseScriptableComponents", 0x50D2D0, &CCamera::InitialiseScriptableComponents);
//    Install("CCamera", "DrawBordersForWideScreen", 0x514860, &CCamera::DrawBordersForWideScreen);
//    Install("CCamera", "Find3rdPersonCamTargetVector", 0x514970, &CCamera::Find3rdPersonCamTargetVector);
//    Install("CCamera", "CalculateGroundHeight", 0x514B80, &CCamera::CalculateGroundHeight);
//    Install("CCamera", "CalculateFrustumPlanes", 0x514D60, &CCamera::CalculateFrustumPlanes);
//    Install("CCamera", "CalculateDerivedValues", 0x5150E0, &CCamera::CalculateDerivedValues);
//    Install("CCamera", "ImproveNearClip", 0x516B20, &CCamera::ImproveNearClip);
//    Install("CCamera", "SetCameraUpForMirror", 0x51A560, &CCamera::SetCameraUpForMirror);
//    Install("CCamera", "RestoreCameraAfterMirror", 0x51A5A0, &CCamera::RestoreCameraAfterMirror);
//    Install("CCamera", "ConeCastCollisionResolve", 0x51A5D0, &CCamera::ConeCastCollisionResolve);
//    Install("CCamera", "TryToStartNewCamMode", 0x51E560, &CCamera::TryToStartNewCamMode);
//    Install("CCamera", "CameraColDetAndReact", 0x520190, &CCamera::CameraColDetAndReact);
//    Install("CCamera", "CamControl", 0x527FA0, &CCamera::CamControl);
//    Install("CCamera", "Process", 0x52B730, &CCamera::Process);
//    Install("CCamera", "DeleteCutSceneCamDataMemory", 0x5B24A0, &CCamera::DeleteCutSceneCamDataMemory);
//    Install("CCamera", "LoadPathSplines", 0x5B24D0, &CCamera::LoadPathSplines);
//    Install("CCamera", "Init", 0x5BC520, &CCamera::Init);

//    Install("CCamera", "ProcessVectorTrackLinear", 0x50D350, &CCamera::ProcessVectorTrackLinear);
//    Install("CCamera", "ProcessVectorTrackLinear", 0x516440, &CCamera::ProcessVectorTrackLinear);
//    Install("CCamera", "ProcessVectorMoveLinear", 0x50D430, &CCamera::ProcessVectorMoveLinear);
//    Install("CCamera", "ProcessVectorMoveLinear", 0x5164A0, &CCamera::ProcessVectorMoveLinear);
//    Install("CCamera", "ProcessFOVLerp", 0x50D510, &CCamera::ProcessFOVLerp);
//    Install("CCamera", "ProcessFOVLerp", 0x516500, &CCamera::ProcessFOVLerp);
//    Install("CCamera", "ProcessJiggle", 0x516560, &CCamera::ProcessJiggle);

//    Install("CCamera", "CamShakeNoPos", 0x50A970, &CGeneral::CamShakeNoPos);
}
