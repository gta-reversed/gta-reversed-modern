...
public:
    ...
    static void CreateRoadBlockBetween2Points(CVector a1, CVector a2, unsigned int a3);
    static void GenerateRoadBlockPedsForCar(CVehicle* a1, int a2, ePedType pedType);
