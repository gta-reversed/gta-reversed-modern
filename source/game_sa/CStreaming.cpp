...
void CStreaming::InjectHooks()
{
    ...
    HookInstall(0x407610, &CStreaming::AddImageToList, 7);
    HookInstall(0x40C520, &CStreaming::AddLodsToRequestList, 7);
    HookInstall(0x40D3F0, &CStreaming::AddModelsToRequestList, 7);
    HookInstall(0x407AD0, &CStreaming::AreAnimsUsedByRequestedModels, 7);
    HookInstall(0x409A90, &CStreaming::AreTexturesUsedByRequestedModels, 7);
    HookInstall(0x407A40, &CStreaming::ClearFlagForAll, 7);
    HookInstall(0x40BAA0, &CStreaming::ClearSlots, 7);
    HookInstall(0x408E20, &CStreaming::GetNextFileOnCd, 7);
    HookInstall(0x407F00, &CStreaming::HasSpecialCharLoaded, 7);
    HookInstall(0x407820, &CStreaming::HasVehicleUpgradeLoaded, 7);
    ...
    HookInstall(0x407D10, &CStreaming::DisableCopBikes, 7);
    HookInstall(0x4076A0, &CStreaming::IsVeryBusy, 7);
    HookInstall(0x5D29E0, &CStreaming::Load, 7);
    HookInstall(0x40EA10, &CStreaming::LoadAllRequestedModels, 7);
    ...
    HookInstall(0x40D3D0, &CStreaming::LoadInitialPeds, 7);
    HookInstall(0x40A120, &CStreaming::LoadInitialWeapons, 7);
    ...
    HookInstall(0x40BA70, &CStreaming::PossiblyStreamCarOutAfterCreation, 7);
    HookInstall(0x4096D0, &CStreaming::RenderEntity, 7);
    HookInstall(0x409430, &CStreaming::RequestBigBuildings, 7);
    HookInstall(0x40A080, &CStreaming::RequestFile, 7);
    ...
    HookInstall(0x408C70, &CStreaming::RequestVehicleUpgrade, 7);
    ...
    HookInstall(0x408000, &CStreaming::AddToLoadedVehiclesList, 7);
    ...
    HookInstall(0x407C00, &CStreaming::GetDefaultCopModel, 7);
    ...
    HookInstall(0x407DD0, &CStreaming::IsCarModelNeededInCurrentZone, 7);
    HookInstall(0x409C90, &CStreaming::SetMissionDoesntRequireModel, 7);
    HookInstall(0x409C10, &CStreaming::SetModelIsDeletable, 7);
    HookInstall(0x4084B0, &CStreaming::Shutdown, 7);
    HookInstall(0x40A2A0, &CStreaming::StreamAmbulanceAndMedic, 7);
    HookInstall(0x40A150, &CStreaming::StreamCopModels, 7);
    HookInstall(0x40A400, &CStreaming::StreamFireEngineAndFireman, 7);
    HookInstall(0x40B4F0, &CStreaming::StreamOneNewCar, 7);
    HookInstall(0x40BBB0, &CStreaming::StreamPedsForInterior, 7);
    HookInstall(0x40BDA0, &CStreaming::StreamPedsIntoRandomSlots, 7);
    ...
    HookInstall(0x407F80, &CStreaming::WeAreTryingToPhaseVehicleOut, 7);
}
