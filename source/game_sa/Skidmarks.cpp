...
uint16 (&CSkidmarks::m_aIndices)[96] = *reinterpret_cast<uint16 (*)[96]>(0xC799C8);
...
//    ReversibleHooks::Install("CSkidmarks", "Init", 0x7204E0, &CSkidmarks::Init);
    ReversibleHooks::Install("CSkidmarks", "RegisterOne_iVffbbf", 0x720EC0, (void (*)(uint32, const CVector&, float, float, const bool*, bool*, float))(&CSkidmarks::RegisterOne));
//    ReversibleHooks::Install("CSkidmarks", "RegisterOne_iVffEbf", 0x720930, (void (*)(uint32, const CVector&, float, float, eSurfaceType, bool*, float))(&CSkidmarks::RegisterOne));
...
// 0x720EC0
void CSkidmarks::RegisterOne(uint32 index, const CVector& posn, float dirX, float dirY, const bool* surfaceType, bool* bloodState, float length) {
...
// 0x720930
void CSkidmarks::RegisterOne(uint32 index, const CVector& posn, float dirX, float dirY, eSurfaceType surfaceType, bool* bloodState, float length) {
    plugin::Call<0x720930, uint32, const CVector&, float, float, eSurfaceType, bool*, float>(index, posn, dirX, dirY, surfaceType, bloodState, length);
}
