...
// 0x5D42E0
int32 C3dMarkers::LoadUser3dMarkers() {
    return plugin::CallAndReturn<int32, 0x5D42E0>();
}

// 0x725120
C3dMarker* C3dMarkers::PlaceMarker(uint32 id, uint16 type, CVector& posn, float size, uint8 r, uint8 g, uint8 b, uint8 a, uint16 pulsePeriod, float pulseFraction, uint16 rotateRate, float nrm_x,
...
// 0x5D4300
int32 C3dMarkers::SaveUser3dMarkers() {
