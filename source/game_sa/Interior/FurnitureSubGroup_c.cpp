...
void FurnitureSubGroup_c::InjectHooks() {
    ...
    // RH_ScopedInstall(Constructor, 0x590E20);
    // 
    // RH_ScopedInstall(Destructor, 0x590E70);
...
// 0x590E20
FurnitureSubGroup_c::FurnitureSubGroup_c() {}

// 0x590E20
FurnitureSubGroup_c* FurnitureSubGroup_c::Constructor() {
    this->FurnitureSubGroup_c::FurnitureSubGroup_c();
    return this;
}
...
// 0x590E70
FurnitureSubGroup_c* FurnitureSubGroup_c::Destructor() {
    this->FurnitureSubGroup_c::~FurnitureSubGroup_c();
    return this;
}
