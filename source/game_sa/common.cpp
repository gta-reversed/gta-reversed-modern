...
RH_ScopedGlobalInstall(FindPlayerCentreOfWorld_NoSniperShift, 0x56E320, { .reversed = false });
RH_ScopedGlobalInstall(FindPlayerCentreOfWorld_NoInteriorShift, 0x56E400, { .reversed = false });
...
RH_ScopedGlobalInstall(Get2DEffectAtomicCallback, 0x734850, { .reversed = false });
...
RH_ScopedGlobalInstall(GetFirstTextureCallback, 0x734930, { .reversed = false });
RH_ScopedGlobalInstall(GetFirstTexture, 0x734940, { .reversed = false });
...
RH_ScopedGlobalInstall(GetAnimHierarchyFromFrame, 0x734AB0, { .reversed = false });
