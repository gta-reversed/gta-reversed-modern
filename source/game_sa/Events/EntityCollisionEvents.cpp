...
{
    ReversibleHooks::Install(0x4AC990, &CEventPedCollisionWithPed::Constructor);
    ReversibleHooks::Install(0x4ACAD0, &CEventPedCollisionWithPed::TakesPriorityOver_Reversed);
    ReversibleHooks::Install(0x4ACB10, &CEventPedCollisionWithPed::AffectsPed_Reversed);
}

void CEventPedCollisionWithPlayer::InjectHooks()
{
    ReversibleHooks::Install(0x5FED40, &CEventPedCollisionWithPlayer::Constructor);
}

void CEventPlayerCollisionWithPed::InjectHooks()
{
    ReversibleHooks::Install(0x5FEE40, &CEventPlayerCollisionWithPed::Constructor);
}

void CEventObjectCollision::InjectHooks()
{
    ReversibleHooks::Install(0x4ACCF0, &CEventObjectCollision::Constructor);
    ReversibleHooks::Install(0x4ACE30, &CEventObjectCollision::AffectsPed_Reversed);
}

void CEventBuildingCollision::InjectHooks()
{
    ReversibleHooks::Install(0x4ACF00, &CEventBuildingCollision::Constructor);
    ReversibleHooks::Install(0x4AD070, &CEventBuildingCollision::AffectsPed_Reversed);
    ReversibleHooks::Install(0x4AD1E0, &CEventBuildingCollision::IsHeadOnCollision);
    ReversibleHooks::Install(0x4B3120, &CEventBuildingCollision::CanTreatBuildingAsObject);
}
