...
void CEventAcquaintancePed::InjectHooks()
{
    ...
    ReversibleHooks::Install(0x4AF820, &CEventAcquaintancePed::Constructor);
    ReversibleHooks::Install(0x4AFA30, &CEventAcquaintancePed::AffectsPed_Reversed);
    ReversibleHooks::Install(0x4AF970, &CEventAcquaintancePed::AffectsPedGroup_Reversed);
    ReversibleHooks::Install(0x4AF8F0, &CEventAcquaintancePed::TakesPriorityOver_Reversed);
}

void CEventSeenCop::InjectHooks()
{
    ReversibleHooks::Install(0x5FF380, &CEventSeenCop::Constructor);
}
...
{
    ReversibleHooks::Install(0x420E70, &CEventAcquaintancePedHate::Constructor);
}
...
{
    ReversibleHooks::Install(0x5FF250, &CEventAcquaintancePedHateBadlyLit::Constructor);
    ReversibleHooks::Install(0x4AFA90, &CEventAcquaintancePedHateBadlyLit::AffectsPed_Reversed);
}
