...
{
    ReversibleHooks::Install(0x61C2E0, &CEventVehicleDamageWeapon::Constructor);
    ReversibleHooks::Install(0x61C330, &CEventVehicleDamageWeapon::CloneEditable_Reversed);
}
