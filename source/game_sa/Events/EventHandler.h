...
public:
    ...
    void ComputeDeadPedResponse(CEvent* e, CTask* tactive, CTask* tsimplest);
    ...
    void ComputeGotKnockedOverByCarResponse(CEvent* e, CTask* tactive, CTask* tsimplest);
    ...
    void ComputePedFriendResponse(CEvent* e, CTask* tactive, CTask* tsimplest);
