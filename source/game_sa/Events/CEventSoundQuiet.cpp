...
{
    ReversibleHooks::Install(0x5E05B0, &CEventSoundQuiet::Constructor);
    ReversibleHooks::Install(0x4B5240, &CEventSoundQuiet::AffectsPed_Reversed);
    ReversibleHooks::Install(0x5E0670, &CEventSoundQuiet::CloneEditable_Reversed);
}
