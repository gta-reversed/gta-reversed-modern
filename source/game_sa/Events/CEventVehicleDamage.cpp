...
{
    ReversibleHooks::Install(0x4B18D0, &CEventVehicleDamage::Constructor);
    ReversibleHooks::Install(0x4B1A00, &CEventVehicleDamage::AffectsPed_Reversed);
    ReversibleHooks::Install(0x4B1A90, &CEventVehicleDamage::IsCriminalEvent_Reversed);
    ReversibleHooks::Install(0x4B50B0, &CEventVehicleDamage::ReportCriminalEvent_Reversed);
    ReversibleHooks::Install(0x4B1A70, &CEventVehicleDamage::GetSourceEntity_Reversed);
}
