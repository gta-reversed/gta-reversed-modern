...
CEventPotentialWalkIntoBuilding::CEventPotentialWalkIntoBuilding() : CEventBuildingCollision(0, 0.0f, m_building, &m_collisionImpactVelocity, &m_collisionPos, m_pieceType) {} // last param pieceType??
