...
{
    ReversibleHooks::Install(0x4ADEA0, &CEventDeadPed::Constructor);
    ReversibleHooks::Install(0x4B4830, &CEventDeadPed::AffectsPed_Reversed);
    ReversibleHooks::Install(0x4B6E70, &CEventDeadPed::CloneEditable_Reversed);
}
