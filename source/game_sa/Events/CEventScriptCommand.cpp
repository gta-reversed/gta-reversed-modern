...
{
    ReversibleHooks::Install(0x4B0A00, &CEventScriptCommand::Constructor);
    ReversibleHooks::Install(0x4B0A30, &CEventScriptCommand::GetEventType);
    ReversibleHooks::Install(0x4B0B20, &CEventScriptCommand::GetEventPriority);
    ReversibleHooks::Install(0x4B6490, &CEventScriptCommand::Clone);
    ReversibleHooks::Install(0x4B0AF0, &CEventScriptCommand::AffectsPed);
    ReversibleHooks::Install(0x4B0BA0, &CEventScriptCommand::TakesPriorityOver);
    ReversibleHooks::Install(0x4B0AB0, &CEventScriptCommand::IsValid);
    ReversibleHooks::Install(0x4B0AA0, &CEventScriptCommand::CloneScriptTask);
}
