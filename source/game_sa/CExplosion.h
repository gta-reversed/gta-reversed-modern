...
public:
    ...
    static bool AddExplosion(CEntity* victim, CEntity* creator, eExplosionType explosionType, CVector const& posn, unsigned int time, bool bMakeSound, float camShake, bool bHideExplosion);
    static void Update();
};
