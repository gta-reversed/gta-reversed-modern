...
public:
    ...
    static void Update();
    static CCheckpoint* PlaceMarker(uint32 id, notsa::WEnumU16<eCheckpointType> type, const CVector& posn, const CVector& direction, float size, CRGBA color, uint16 pulsePeriod, float pulseFraction, int16 rotateRate);
    /*!
