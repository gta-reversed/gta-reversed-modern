...
public:
    ...
    static void Update();
    static CCheckpoint* PlaceMarker(uint32 id, uint16 type, CVector& posn, CVector& direction, float size, CRGBA color, uint16 pulsePeriod, float pulseFraction, int16 rotateRate);
