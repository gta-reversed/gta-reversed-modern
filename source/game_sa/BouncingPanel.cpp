...
void CBouncingPanel::InjectHooks() {
    ReversibleHooks::Install("Global/CBouncingPanel", "ResetPanel", 0x6F4910, &CBouncingPanel::ResetPanel);
    ReversibleHooks::Install("Global/CBouncingPanel", "SetPanel", 0x6F4920, &CBouncingPanel::SetPanel);
    ReversibleHooks::Install("Global/CBouncingPanel", "ProcessPanel", 0x6F49A0, &CBouncingPanel::ProcessPanel);
}
