...
public:
    ...
    auto GetAnimLoopStart(bool isSet2) const { return isSet2 ? m_fAnimLoop2Start : m_fAnimLoopStart; }
    auto GetAnimLoopEnd(bool isSet2) const { return isSet2 ? m_fAnimLoop2End : m_fAnimLoopEnd; }
