...
void CAEWaveDecoder::InjectHooks()
{
    ...
    ReversibleHooks::Install(0x503250, &CAEWaveDecoder::ctor);
    ReversibleHooks::Install(0x503290, &CAEWaveDecoder::dtor);
    ReversibleHooks::Install(0x5032b0, &CAEWaveDecoder::Initialise);
    ReversibleHooks::Install(0x502470, &CAEWaveDecoder::FillBuffer);
    ReversibleHooks::Install(0x503310, &CAEWaveDecoder::GetStreamLengthMs);
    ReversibleHooks::Install(0x503360, &CAEWaveDecoder::GetStreamPlayTimeMs);
    ReversibleHooks::Install(0x5033c0, &CAEWaveDecoder::SetCursor);
    ReversibleHooks::Install(0x503300, &CAEWaveDecoder::GetSampleRate);
    ReversibleHooks::Install(0x503280, &CAEWaveDecoder::GetStreamID);
#endif
}
