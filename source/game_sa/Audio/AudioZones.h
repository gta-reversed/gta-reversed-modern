...
public:
    ...
    static void RegisterAudioBox(char name[8], int32 id, bool isActive, float x1, float y1, float z1, float x2, float y2, float z2);
    static void RegisterAudioSphere(char name[8], int32 id, bool isActive, float x1, float y1, float z1, float radius);
