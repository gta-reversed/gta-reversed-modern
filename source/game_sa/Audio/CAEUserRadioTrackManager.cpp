...
void CAEUserRadioTrackManager::InjectHooks()
{
    ...
    ReversibleHooks::Install(0x4f2fb0, &CAEUserRadioTrackManager::Shutdown);
    ReversibleHooks::Install(0x4f2fd0, &CAEUserRadioTrackManager::ReadUserTracks);
    ReversibleHooks::Install(0x4f3050, &CAEUserRadioTrackManager::GetTrackPath);
    ReversibleHooks::Install(0x4f30f0, (char*(CAEUserRadioTrackManager::*)(const char*)) &CAEUserRadioTrackManager::ResolveShortcut);
    ReversibleHooks::Install(0x4f31f0, &CAEUserRadioTrackManager::GetAudioFileType);
    ReversibleHooks::Install(0x4f3250, &CAEUserRadioTrackManager::SelectUserTrackIndex);
    ReversibleHooks::Install(0x4f32f0, &CAEUserRadioTrackManager::DeleteUserTracksInfo);
    ReversibleHooks::Install(0x4f32c0, &CAEUserRadioTrackManager::IsShortcut);
    ReversibleHooks::Install(0x4f35b0, &CAEUserRadioTrackManager::Initialise);
    ReversibleHooks::Install(0x4f35f0, &CAEUserRadioTrackManager::LoadUserTrack);
    ReversibleHooks::Install(0x4f3330, &CAEUserRadioTrackManager::GetUserTrackPlayMode);
    ReversibleHooks::Install(0x4f3340, &CAEUserRadioTrackManager::SetUserTrackIndex);
    ReversibleHooks::Install(0x4f4690, (int(CAEUserRadioTrackManager::*)(const char*, size_t&, FILE*, std::vector<tUserTracksInfo>&, int)) &CAEUserRadioTrackManager::WriteUserTracksFile);
    ReversibleHooks::Install(0x4f4a20, &CAEUserRadioTrackManager::WriteUserTracksThread);
    ReversibleHooks::Install(0x4f4ba0, &CAEUserRadioTrackManager::ScanUserTracks);
#endif
}
