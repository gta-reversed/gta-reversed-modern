...
public:
    ...
    static void ClipTargetOrientationToLink(CVehicle* vehicle, CCarPathLinkAddress arg2, int8 arg3, float* arg4, float arg5, float arg6);
    ...
    static bool JoinCarWithRoadSystemGotoCoors(CVehicle* vehicle, CVector const& posn, bool unused, bool bIsBoat);
    ...
    static void SteerAICarWithPhysicsHeadingForTarget(CVehicle* vehicle, CPhysical* pTarget, float arg3, float arg4, float* arg5, float* arg6, float* arg7, bool* arg8);
    ...
    static void TestWhetherToFirePlaneGuns(CVehicle* vehicle, CEntity* pTarget);
