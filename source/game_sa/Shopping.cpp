...
//    Install("CShopping", "AddPriceModifier", 0x0, &CShopping::AddPriceModifier);
//    Install("CShopping", "AddPriceModifier", 0x0, &CShopping::AddPriceModifier);
//    Install("CShopping", "Buy", 0x49BF70, &CShopping::Buy);
//    Install("CShopping", "FindItem", 0x0, &CShopping::FindItem);
//    Install("CShopping", "FindSection", 0x49AE70, &CShopping::FindSection);
//    Install("CShopping", "FindSectionInSection", 0x49AF90, &CShopping::FindSectionInSection);
//    Install("CShopping", "GetExtraInfo", 0x49ADE0, &CShopping::GetExtraInfo);
//    Install("CShopping", "GetItemIndex", 0x49AB10, &CShopping::GetItemIndex);
//    Install("CShopping", "GetKey", 0x49AB30, &CShopping::GetKey);
//    Install("CShopping", "GetNameTag", 0x0, &CShopping::GetNameTag);
//    Install("CShopping", "GetNextSection", 0x49AF10, &CShopping::GetNextSection);
//    Install("CShopping", "GetPrice", 0x49AD50, &CShopping::GetPrice);
//    Install("CShopping", "GetPriceSectionFromName", 0x49AAD0, &CShopping::GetPriceSectionFromName);
//    Install("CShopping", "HasPlayerBought", 0x49B5E0, &CShopping::HasPlayerBought);
//    Install("CShopping", "IncrementStat", 0x0, &CShopping::IncrementStat);
//    Install("CShopping", "IncrementStat2", 0x0, &CShopping::IncrementStat2);
//    Install("CShopping", "Init", 0x49C290, &CShopping::Init);
//    Install("CShopping", "Load", 0x5D3E40, &CShopping::Load);
//    Install("CShopping", "LoadPrices", 0x49B8D0, &CShopping::LoadPrices);
//    Install("CShopping", "LoadShop", 0x49BBE0, &CShopping::LoadShop);
//    Install("CShopping", "LoadStats", 0x49B6A0, &CShopping::LoadStats);
//    Install("CShopping", "RemoveLoadedPrices", 0x0, &CShopping::RemoveLoadedPrices);
//    Install("CShopping", "RemoveLoadedShop", 0x49AE30, &CShopping::RemoveLoadedShop);
//    Install("CShopping", "RemovePriceModifier", 0x0, &CShopping::RemovePriceModifier);
//    Install("CShopping", "RemovePriceModifier", 0x0, &CShopping::RemovePriceModifier);
//    Install("CShopping", "RestoreClothesState", 0x49B240, &CShopping::RestoreClothesState);
//    Install("CShopping", "RestoreVehicleMods", 0x49B3C0, &CShopping::RestoreVehicleMods);
//    Install("CShopping", "Save", 0x5D3DE0, &CShopping::Save);
//    Install("CShopping", "SetPlayerHasBought", 0x49B610, &CShopping::SetPlayerHasBought);
//    Install("CShopping", "ShutdownForRestart", 0x49B640, &CShopping::ShutdownForRestart);
//    Install("CShopping", "StoreClothesState", 0x49B200, &CShopping::StoreClothesState);
//    Install("CShopping", "StoreVehicleMods", 0x0, &CShopping::StoreVehicleMods);
//    Install("CShopping", "UpdateStats", 0x0, &CShopping::UpdateStats);
}
