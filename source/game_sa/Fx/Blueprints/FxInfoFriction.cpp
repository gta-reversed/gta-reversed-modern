...
// 0x4A55E0
void FxInfoFriction_c::GetValue(float currentTime, float mult, float totalTime, float length, bool bConstTimeSet, void* info) {
    ...
    movement.m_v1 *= std::pow(values[0], totalTime * 50.0f);
}
