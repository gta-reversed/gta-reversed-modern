...
{
    Install("CTrafficLights", "ShouldCarStopForLight", 0x49D610, &CTrafficLights::ShouldCarStopForLight);
    Install("CTrafficLights", "ShouldCarStopForBridge", 0x49D420, &CTrafficLights::ShouldCarStopForBridge);
    Install("CTrafficLights", "IsMITrafficLight", 0x49D5A0, &CTrafficLights::IsMITrafficLight);
    Install("CTrafficLights", "DisplayActualLight", 0x49DAB0, &CTrafficLights::DisplayActualLight);
    Install("CTrafficLights", "FindTrafficLightType", 0x49D580, &CTrafficLights::FindTrafficLightType);
    Install("CTrafficLights", "FindTrafficLightTypeFromOrientation", 0x49D4D0, &CTrafficLights::FindTrafficLightTypeFromOrientation);
    Install("CTrafficLights", "FindOrientationForTrafficLightType", 0x49D520, &CTrafficLights::FindOrientationForTrafficLightType);
    Install("CTrafficLights", "LightForPeds", 0x49D400, &CTrafficLights::LightForPeds);
    Install("CTrafficLights", "LightForCars1", 0x49D2D0, &CTrafficLights::LightForCars1);
    Install("CTrafficLights", "LightForCars2", 0x49D310, &CTrafficLights::LightForCars2);
    Install("CTrafficLights", "LightForCars1_Visual", 0x49D350, &CTrafficLights::LightForCars1_Visual);
    Install("CTrafficLights", "LightForCars2_Visual", 0x49D3A0, &CTrafficLights::LightForCars2_Visual);
}
