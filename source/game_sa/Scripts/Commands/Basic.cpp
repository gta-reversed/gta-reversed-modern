...
void notsa::script::commands::basic::RegisterHandlers() {
    ...
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_INT_VAR_NOT_EQUAL_TO_NUMBER);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_INT_LVAR_NOT_EQUAL_TO_NUMBER);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_INT_VAR_NOT_EQUAL_TO_INT_VAR);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_INT_LVAR_NOT_EQUAL_TO_INT_LVAR);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_INT_VAR_NOT_EQUAL_TO_INT_LVAR);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_FLOAT_VAR_NOT_EQUAL_TO_NUMBER);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_FLOAT_LVAR_NOT_EQUAL_TO_NUMBER);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_FLOAT_VAR_NOT_EQUAL_TO_FLOAT_VAR);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_FLOAT_LVAR_NOT_EQUAL_TO_FLOAT_LVAR);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_IS_FLOAT_VAR_NOT_EQUAL_TO_FLOAT_LVAR);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_GOTO_IF_TRUE);
    REGISTER_COMMAND_HANDLER_UNIMPLEMENTED(COMMAND_LINE);
}
