...
void CRunningScript::InjectHooks() {
    Install("CRunningScript", "Init", 0x4648E0, &CRunningScript::Init);
//    Install("CRunningScript", "LocateCarCommand", 0x487A20, &CRunningScript::LocateCarCommand);
//    Install("CRunningScript", "LocateObjectCommand", 0x487D10, &CRunningScript::LocateObjectCommand);
//    Install("CRunningScript", "PlayAnimScriptCommand", 0x470150, &CRunningScript::PlayAnimScriptCommand);
//    Install("CRunningScript", "LocateCharCommand", 0x486D80, &CRunningScript::LocateCharCommand);
//    Install("CRunningScript", "LocateCharCarCommand", 0x487420, &CRunningScript::LocateCharCarCommand);
//    Install("CRunningScript", "LocateCharCharCommand", 0x4870F0, &CRunningScript::LocateCharCharCommand);
//    Install("CRunningScript", "LocateCharObjectCommand", 0x487720, &CRunningScript::LocateCharObjectCommand);
//    Install("CRunningScript", "CarInAreaCheckCommand", 0x488EC0, &CRunningScript::CarInAreaCheckCommand);
//    Install("CRunningScript", "CharInAreaCheckCommand", 0x488B50, &CRunningScript::CharInAreaCheckCommand);
//    Install("CRunningScript", "ObjectInAreaCheckCommand", 0x489150, &CRunningScript::ObjectInAreaCheckCommand);
//    Install("CRunningScript", "CharInAngledAreaCheckCommand", 0x487F60, &CRunningScript::CharInAngledAreaCheckCommand);
//    Install("CRunningScript", "FlameInAngledAreaCheckCommand", 0x488780, &CRunningScript::FlameInAngledAreaCheckCommand);
//    Install("CRunningScript", "ObjectInAngledAreaCheckCommand", 0x4883F0, &CRunningScript::ObjectInAngledAreaCheckCommand);
//    Install("CRunningScript", "CollectParameters", 0x464080, &CRunningScript::CollectParameters);
//    Install("CRunningScript", "CollectNextParameterWithoutIncreasingPC", 0x464250, &CRunningScript::CollectNextParameterWithoutIncreasingPC);
//    Install("CRunningScript", "StoreParameters", 0x464370, &CRunningScript::StoreParameters);
//    Install("CRunningScript", "ReadArrayInformation", 0x463CF0, &CRunningScript::ReadArrayInformation);
//    Install("CRunningScript", "ReadParametersForNewlyStartedScript", 0x464500, &CRunningScript::ReadParametersForNewlyStartedScript);
//    Install("CRunningScript", "ReadTextLabelFromScript", 0x463D50, &CRunningScript::ReadTextLabelFromScript);
//    Install("CRunningScript", "GetCorrectPedModelIndexForEmergencyServiceType", 0x464F50, &CRunningScript::GetCorrectPedModelIndexForEmergencyServiceType);
//    Install("CRunningScript", "GetIndexOfGlobalVariable", 0x464700, &CRunningScript::GetIndexOfGlobalVariable);
//    Install("CRunningScript", "GetPadState", 0x485B10, &CRunningScript::GetPadState);
//    Install("CRunningScript", "GetPointerToLocalVariable", 0x, &CRunningScript::GetPointerToLocalVariable);
//    Install("CRunningScript", "GetPointerToLocalArrayElement", 0x463CC0, &CRunningScript::GetPointerToLocalArrayElement);
//    Install("CRunningScript", "GetPointerToScriptVariable", 0x464790, &CRunningScript::GetPointerToScriptVariable);
//    Install("CRunningScript", "DoDeathArrestCheck", 0x485A50, &CRunningScript::DoDeathArrestCheck);
//    Install("CRunningScript", "SetCharCoordinates", 0x464DC0, &CRunningScript::SetCharCoordinates);
//    Install("CRunningScript", "GivePedScriptedTask", 0x465C20, &CRunningScript::GivePedScriptedTask);
//    Install("CRunningScript", "AddScriptToList", 0x, &CRunningScript::AddScriptToList);
//    Install("CRunningScript", "RemoveScriptFromList", 0x464BD0, &CRunningScript::RemoveScriptFromList);
//    Install("CRunningScript", "ShutdownThisScript", 0x465AA0, &CRunningScript::ShutdownThisScript);
    Install("CRunningScript", "IsPedDead", 0x464D70, &CRunningScript::IsPedDead);
//    Install("CRunningScript", "ThisIsAValidRandomPed", 0x489490, &CRunningScript::ThisIsAValidRandomPed);
//    Install("CRunningScript", "ScriptTaskPickUpObject", 0x46AF50, &CRunningScript::ScriptTaskPickUpObject);
//    Install("CRunningScript", "UpdateCompareFlag", 0x4859D0, &CRunningScript::UpdateCompareFlag);
//    Install("CRunningScript", "UpdatePC", 0x464DA0, &CRunningScript::UpdatePC);
//    Install("CRunningScript", "ProcessOneCommand", 0x469EB0, &CRunningScript::ProcessOneCommand);

//    Install("CRunningScript", "Process", 0x469F00, &CRunningScript::Process);

//    Install("CRunningScript", "ProcessCommands0To99", 0x465E60, &CRunningScript::ProcessCommands0To99);
//    Install("CRunningScript", "ProcessCommands100To199", 0x466DE0, &CRunningScript::ProcessCommands100To199);
//    Install("CRunningScript", "ProcessCommands200To299", 0x469390, &CRunningScript::ProcessCommands200To299);
//    Install("CRunningScript", "ProcessCommands300To399", 0x47C100, &CRunningScript::ProcessCommands300To399);
//    Install("CRunningScript", "ProcessCommands400To499", 0x47D210, &CRunningScript::ProcessCommands400To499);
//    Install("CRunningScript", "ProcessCommands500To599", 0x47E090, &CRunningScript::ProcessCommands500To599);
//    Install("CRunningScript", "ProcessCommands600To699", 0x47F370, &CRunningScript::ProcessCommands600To699);
//    Install("CRunningScript", "ProcessCommands700To799", 0x47FA30, &CRunningScript::ProcessCommands700To799);
//    Install("CRunningScript", "ProcessCommands800To899", 0x481300, &CRunningScript::ProcessCommands800To899);
//    Install("CRunningScript", "ProcessCommands900To999", 0x483BD0, &CRunningScript::ProcessCommands900To999);
//    Install("CRunningScript", "ProcessCommands1000To1099", 0x489500, &CRunningScript::ProcessCommands1000To1099);
//    Install("CRunningScript", "ProcessCommands1100To1199", 0x48A320, &CRunningScript::ProcessCommands1100To1199);
//    Install("CRunningScript", "ProcessCommands1200To1299", 0x48B590, &CRunningScript::ProcessCommands1200To1299);
//    Install("CRunningScript", "ProcessCommands1300To1399", 0x48CDD0, &CRunningScript::ProcessCommands1300To1399);
//    Install("CRunningScript", "ProcessCommands1400To1499", 0x48EAA0, &CRunningScript::ProcessCommands1400To1499);
//    Install("CRunningScript", "ProcessCommands1500To1599", 0x490DB0, &CRunningScript::ProcessCommands1500To1599);
//    Install("CRunningScript", "ProcessCommands1600To1699", 0x493FE0, &CRunningScript::ProcessCommands1600To1699);
//    Install("CRunningScript", "ProcessCommands1700To1799", 0x496E00, &CRunningScript::ProcessCommands1700To1799);
//    Install("CRunningScript", "ProcessCommands1800To1899", 0x46D050, &CRunningScript::ProcessCommands1800To1899);
//    Install("CRunningScript", "ProcessCommands1900To1999", 0x46B460, &CRunningScript::ProcessCommands1900To1999);
//    Install("CRunningScript", "ProcessCommands2000To2099", 0x472310, &CRunningScript::ProcessCommands2000To2099);
//    Install("CRunningScript", "ProcessCommands2100To2199", 0x470A90, &CRunningScript::ProcessCommands2100To2199);
//    Install("CRunningScript", "ProcessCommands2200To2299", 0x474900, &CRunningScript::ProcessCommands2200To2299);
//    Install("CRunningScript", "ProcessCommands2300To2399", 0x4762D0, &CRunningScript::ProcessCommands2300To2399);
//    Install("CRunningScript", "ProcessCommands2400To2499", 0x478000, &CRunningScript::ProcessCommands2400To2499);
//    Install("CRunningScript", "ProcessCommands2500To2599", 0x47A760, &CRunningScript::ProcessCommands2500To2599);
//    Install("CRunningScript", "ProcessCommands2600To2699", 0x479DA0, &CRunningScript::ProcessCommands2600To2699);
}
