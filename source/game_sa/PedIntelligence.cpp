...
void CPedIntelligence::InjectHooks()
{
    ...
    RH_ScopedInstall(GetPedEntities, 0x4893E0, { .enabled = false });
    RH_ScopedInstall(SetPedDecisionMakerType, 0x600B50, {.enabled = false});
    RH_ScopedInstall(SetPedDecisionMakerTypeInGroup, 0x600BB0, {.enabled = false});
    RH_ScopedInstall(RestorePedDecisionMakerType, 0x600BC0, {.enabled = false});
    RH_ScopedInstall(SetHearingRange, 0x600BE0, {.enabled = false});
    RH_ScopedInstall(SetSeeingRange, 0x600BF0, {.enabled = false});
    RH_ScopedInstall(IsInSeeingRange, 0x600C60, {.enabled = false});
    RH_ScopedInstall(FindRespectedFriendInInformRange, 0x600CF0, {.enabled = false});
    RH_ScopedInstall(IsRespondingToEvent, 0x600DB0, {.enabled = false});
    RH_ScopedInstall(AddTaskPhysResponse, 0x600DC0, {.enabled = false});
    RH_ScopedInstall(AddTaskEventResponseTemp, 0x600DE0, {.enabled = false});
    RH_ScopedInstall(AddTaskEventResponseNonTemp, 0x600E00, {.enabled = false});
    RH_ScopedInstall(AddTaskPrimaryMaybeInGroup, 0x600E20, {.enabled = false});
    RH_ScopedInstall(FindTaskByType, 0x600EE0, {.enabled = false});
    RH_ScopedInstall(GetTaskFighting, 0x600F30, {.enabled = false});
    RH_ScopedInstall(GetTaskUseGun, 0x600F70, {.enabled = false});
    RH_ScopedInstall(GetTaskThrow, 0x600FB0, {.enabled = false});
    RH_ScopedInstall(GetTaskHold, 0x600FF0, {.enabled = false});
    RH_ScopedInstall(GetTaskSwim, 0x601070, {.enabled = false});
    RH_ScopedInstall(GetTaskDuck, 0x6010A0, {.enabled = false});
    RH_ScopedInstall(GetTaskJetPack, 0x601110, {.enabled = false});
    RH_ScopedInstall(GetTaskInAir, 0x601150, {.enabled = false});
    RH_ScopedInstall(GetTaskClimb, 0x601180, {.enabled = false});
    RH_ScopedInstall(GetUsingParachute, 0x6011B0, {.enabled = false});
    RH_ScopedInstall(SetTaskDuckSecondary, 0x601230, {.enabled = false});
    RH_ScopedInstall(ClearTaskDuckSecondary, 0x601390, {.enabled = false});
    RH_ScopedInstall(ClearTasks, 0x601420, {.enabled = false});
    RH_ScopedInstall(FlushImmediately, 0x601640, {.enabled = false});
    RH_ScopedInstall(GetEffectInUse, 0x6018D0, {.enabled = false});
    RH_ScopedInstall(SetEffectInUse, 0x6018E0, {.enabled = false});
    RH_ScopedInstall(ProcessAfterProcCol, 0x6018F0, {.enabled = false});
    RH_ScopedInstall(ProcessAfterPreRender, 0x6019B0, {.enabled = false});
    RH_ScopedInstall(ProcessEventHandler, 0x601BB0, {.enabled = false});
    RH_ScopedInstall(IsFriendlyWith, 0x601BC0, {.enabled = false});
    RH_ScopedInstall(IsThreatenedBy, 0x601C30, {.enabled = false});
    RH_ScopedInstall(Respects, 0x601C90, {.enabled = false});
    RH_ScopedInstall(IsInACarOrEnteringOne, 0x601CC0, {.enabled = false});
    RH_ScopedInstall(AreFriends, 0x601D10, {.enabled = false});
    RH_ScopedInstall(GetMoveStateFromGoToTask, 0x601D70, {.enabled = false});
    RH_ScopedInstall(FlushIntelligence, 0x601DA0, {.enabled = false});
    RH_ScopedInstall(TestForStealthKill, 0x601E00, {.enabled = false});
    RH_ScopedInstall(RecordEventForScript, 0x602050, {.enabled = false});
    RH_ScopedInstall(IsInterestingEntity, 0x6020A0, {.enabled = false});
    RH_ScopedInstall(LookAtInterestingEntities, 0x6020D0, {.enabled = false});
    RH_ScopedInstall(IsPedGoingForCarDoor, 0x602350, {.enabled = false});
    RH_ScopedInstall(CanSeeEntityWithLights, 0x605550, {.enabled = false});
    RH_ScopedInstall(ProcessStaticCounter, 0x605650, {.enabled = false});
    RH_ScopedInstall(ProcessFirst, 0x6073A0, {.enabled = false});
    RH_ScopedInstall(Process, 0x608260, {.enabled = false});
    RH_ScopedInstall(GetActivePrimaryTask, 0x4B85B0, {.enabled = false});
}
...
void CPedIntelligence::FlushImmediately(bool bSetPrimaryDefaultTask) {
    ...
    if (taskBeInGroup) {
        ...
        if (!pedGroup || m_pPed->IsPlayer()) {
            ...
            m_TaskMgr.SetTask(taskBeInGroup, TASK_PRIMARY_PRIMARY, false);
        }
    }
