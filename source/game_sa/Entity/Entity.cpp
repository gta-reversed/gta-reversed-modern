...
//Virtual
    ...
    Install("CEntity", "CreateRwObject", 0x533D30, &CEntity::CreateRwObject_Reversed);
    Install("CEntity", "DeleteRwObject", 0x534030, &CEntity::DeleteRwObject_Reversed);
    Install("CEntity", "GetBoundRect", 0x534120, &CEntity::GetBoundRect_Reversed);
    Install("CEntity", "ProcessControl", 0x403E40, &CEntity::ProcessControl_Reversed);
    Install("CEntity", "ProcessCollision", 0x403E50, &CEntity::ProcessCollision_Reversed);
    Install("CEntity", "ProcessShift", 0x403E60, &CEntity::ProcessShift_Reversed);
    Install("CEntity", "TestCollision", 0x403E70, &CEntity::TestCollision_Reversed);
    Install("CEntity", "Teleport", 0x403E80, &CEntity::Teleport_Reversed);
    Install("CEntity", "SpecialEntityPreCollisionStuff", 0x403E90, &CEntity::SpecialEntityPreCollisionStuff_Reversed);
    Install("CEntity", "SpecialEntityCalcCollisionSteps", 0x403EA0, &CEntity::SpecialEntityCalcCollisionSteps_Reversed);
    Install("CEntity", "PreRender", 0x535FA0, &CEntity::PreRender_Reversed);
    Install("CEntity", "Render", 0x534310, &CEntity::Render_Reversed);
    Install("CEntity", "SetupLighting", 0x553DC0, &CEntity::SetupLighting_Reversed);
    Install("CEntity", "RemoveLighting", 0x553370, &CEntity::RemoveLighting_Reversed);
    Install("CEntity", "FlagToDestroyWhenNextProcessed", 0x533240, &CEntity::FlagToDestroyWhenNextProcessed_Reversed);

//Class
    Install("CEntity", "UpdateRwFrame", 0x532B00, &CEntity::UpdateRwFrame);
    Install("CEntity", "UpdateRpHAnim", 0x532B20, &CEntity::UpdateRpHAnim);
    Install("CEntity", "HasPreRenderEffects", 0x532B70, &CEntity::HasPreRenderEffects);
    Install("CEntity", "DoesNotCollideWithFlyers", 0x532D40, &CEntity::DoesNotCollideWithFlyers);
    Install("CEntity", "ModifyMatrixForPoleInWind", 0x532DB0, &CEntity::ModifyMatrixForPoleInWind);
    Install("CEntity", "LivesInThisNonOverlapSector", 0x533050, &CEntity::LivesInThisNonOverlapSector);
    Install("CEntity", "SetupBigBuilding", 0x533150, &CEntity::SetupBigBuilding);
    Install("CEntity", "ModifyMatrixForCrane", 0x533170, &CEntity::ModifyMatrixForCrane);
    Install("CEntity", "PreRenderForGlassWindow", 0x533170, &CEntity::PreRenderForGlassWindow);
    Install("CEntity", "SetRwObjectAlpha", 0x5332C0, &CEntity::SetRwObjectAlpha);
    Install("CEntity", "FindTriggerPointCoors", 0x533380, &CEntity::FindTriggerPointCoors);
    Install("CEntity", "GetRandom2dEffect", 0x533410, &CEntity::GetRandom2dEffect);
    ...
    Install("CEntity", "CreateEffects", 0x533790, &CEntity::CreateEffects);
    Install("CEntity", "DestroyEffects", 0x533BF0, &CEntity::DestroyEffects);
    Install("CEntity", "AttachToRwObject", 0x533ED0, &CEntity::AttachToRwObject);
    Install("CEntity", "DetachFromRwObject", 0x533FB0, &CEntity::DetachFromRwObject);
    ...
    Install("CEntity", "RenderEffects", 0x5342B0, &CEntity::RenderEffects);
    ...
    Install("CEntity", "GetIsOnScreen", 0x534540, &CEntity::GetIsOnScreen);
    Install("CEntity", "GetIsBoundingBoxOnScreen", 0x5345D0, &CEntity::GetIsBoundingBoxOnScreen);
    Install("CEntity", "ModifyMatrixForTreeInWind", 0x534E90, &CEntity::ModifyMatrixForTreeInWind);
    Install("CEntity", "ModifyMatrixForBannerInWind", 0x535040, &CEntity::ModifyMatrixForBannerInWind);
    Install("CEntity", "GetColModel", 0x535300, &CEntity::GetColModel);
    Install("CEntity", "CalculateBBProjection", 0x535340, &CEntity::CalculateBBProjection);
    Install("CEntity", "UpdateAnim", 0x535F00, &CEntity::UpdateAnim);
    Install("CEntity", "IsVisible", 0x536BC0, &CEntity::IsVisible);
    Install("CEntity", "GetDistanceFromCentreOfMassToBaseOfModel", 0x536BE0, &CEntity::GetDistanceFromCentreOfMassToBaseOfModel);
    Install("CEntity", "CleanUpOldReference", 0x571A00, &CEntity::CleanUpOldReference);
    Install("CEntity", "ResolveReferences", 0x571A40, &CEntity::ResolveReferences);
    Install("CEntity", "PruneReferences", 0x571A90, &CEntity::PruneReferences);
    Install("CEntity", "RegisterReference", 0x571B70, &CEntity::RegisterReference);
    Install("CEntity", "ProcessLightsForEntity", 0x6FC7A0, &CEntity::ProcessLightsForEntity);
    Install("CEntity", "RemoveEscalatorsForEntity", 0x717900, &CEntity::RemoveEscalatorsForEntity);
    Install("CEntity", "IsEntityOccluded", 0x71FAE0, &CEntity::IsEntityOccluded);
    Install("CEntity", "GetModellingMatrix", 0x46A2D0, &CEntity::GetModellingMatrix);
    Install("CEntity", "UpdateRW", 0x446F90, &CEntity::UpdateRW);
    Install("CEntity", "SetAtomicAlphaCB", 0x533290, &CEntity::SetAtomicAlphaCB);
    Install("CEntity", "SetMaterialAlphaCB", 0x533280, &CEntity::SetMaterialAlphaCB);

//Statics
    Install("CEntity", "MaterialUpdateUVAnimCB", 0x532D70, &MaterialUpdateUVAnimCB);
    Install("CEntity", "IsEntityPointerValid", 0x533310, &IsEntityPointerValid);
}
