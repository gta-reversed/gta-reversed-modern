...
void CPed::InjectHooks() {
    // Constructors
    // Install("CPed", "CPed", 0x5E8030, &CPed::Constructor);
    ...
    // Install("CPed", "SpawnFlyingComponent", 0x5F0190, &CPed::SpawnFlyingComponent);
    // Install("CPed", "PedCanPickUpPickUp", 0x455560, &CPed::PedCanPickUpPickUp);
    // Install("CPed", "Update", 0x5DEBE0, &CPed::Update);
    Install("CPed", "Initialise", 0x5DEBB0, &CPed::Initialise);
    // Install("CPed", "UpdateStatLeavingVehicle", 0x5E01B0, &CPed::UpdateStatLeavingVehicle);
    // Install("CPed", "UpdateStatEnteringVehicle", 0x5E01A0, &CPed::UpdateStatEnteringVehicle);
    // Install("CPed", "ShoulderBoneRotation", 0x5DF560, &CPed::ShoulderBoneRotation);
    // Install("CPed", "RestoreHeadingRateCB", 0x5DFD70, &CPed::RestoreHeadingRateCB);
    ...
    // Install("CPed", "PlayFootSteps", 0x5E57F0, &CPed::PlayFootSteps);
    // Install("CPed", "DoFootLanded", 0x5E5380, &CPed::DoFootLanded);
    // Install("CPed", "ClearAll", 0x5E5320, &CPed::ClearAll);
    // Install("CPed", "CalculateNewOrientation", 0x5E52E0, &CPed::CalculateNewOrientation);
    // Install("CPed", "CalculateNewVelocity", 0x5E4C50, &CPed::CalculateNewVelocity);
    // Install("CPed", "SetCharCreatedBy", 0x5E47E0, &CPed::SetCharCreatedBy);
    // Install("CPed", "SetPedState", 0x5E4500, &CPed::SetPedState);
    // Install("CPed", "GiveObjectToPedToHold", 0x5E4390, &CPed::GiveObjectToPedToHold);
    // Install("CPed", "ClearLookFlag", 0x5E1950, &CPed::ClearLookFlag);
    // Install("CPed", "WorkOutHeadingForMovingFirstPerson", 0x5E1A00, &CPed::WorkOutHeadingForMovingFirstPerson);
    // Install("CPed", "UpdatePosition", 0x5E1B10, &CPed::UpdatePosition);
    // Install("CPed", "MakeTyresMuddySectorList", 0x6AE0D0, &CPed::MakeTyresMuddySectorList);
    Install("CPed", "IsPedInControl", 0x5E3960, &CPed::IsPedInControl);
    // Install("CPed", "RemoveWeaponModel", 0x5E3990, &CPed::RemoveWeaponModel);
    // Install("CPed", "RemoveWeaponWhenEnteringVehicle", 0x5E6370, &CPed::RemoveWeaponWhenEnteringVehicle);
    // Install("CPed", "AddGogglesModel", 0x5E3A90, &CPed::AddGogglesModel);
    // Install("CPed", "SetWeaponSkill", 0x5E3C10, &CPed::SetWeaponSkill);
    // Install("CPed", "ClearLook", 0x5E3FF0, &CPed::ClearLook);
    // Install("CPed", "TurnBody", 0x5E4000, &CPed::TurnBody);
    // Install("CPed", "IsPointerValid", 0x5E4220, &CPed::IsPointerValid);
    // Install("CPed", "GetBonePosition", 0x5E4280, &CPed::GetBonePosition);
    // Install("CPed", "PutOnGoggles", 0x5E3AE0, &CPed::PutOnGoggles);
    // Install("CPed", "SortPeds", 0x5E17E0, &CPed::SortPeds);
    // Install("CPed", "ReplaceWeaponWhenExitingVehicle", 0x5E6490, &CPed::ReplaceWeaponWhenExitingVehicle);
    // Install("CPed", "KillPedWithCar", 0x5F0360, &CPed::KillPedWithCar);
    // Install("CPed", "IsPedHeadAbovePos", 0x5F02C0, &CPed::IsPedHeadAbovePos);
    // Install("CPed", "RemoveWeaponAnims", 0x5F0250, &CPed::RemoveWeaponAnims);
    // Install("CPed", "DoesLOSBulletHitPed", 0x5F01A0, &CPed::DoesLOSBulletHitPed);
    // Install("CPed", "RemoveBodyPart", 0x5F0140, &CPed::RemoveBodyPart);
    // Install("CPed", "Say", 0x5EFFE0, &CPed::Say);
    // Install("CPed", "SayScript", 0x5EFFB0, &CPed::SayScript);
    // Install("CPed", "CanPedHoldConversation", 0x5EFFA0, &CPed::CanPedHoldConversation);
    // Install("CPed", "EnablePedSpeechForScriptSpeech", 0x5EFF90, &CPed::EnablePedSpeechForScriptSpeech);
    // Install("CPed", "DisablePedSpeechForScriptSpeech", 0x5EFF80, &CPed::DisablePedSpeechForScriptSpeech);
    // Install("CPed", "EnablePedSpeech", 0x5EFF70, &CPed::EnablePedSpeech);
    // Install("CPed", "DisablePedSpeech", 0x5EFF60, &CPed::DisablePedSpeech);
    ...
    Install("CPed", "GiveWeaponAtStartOfFight", 0x5E8AB0, &CPed::GiveWeaponAtStartOfFight);
    Install("CPed", "ProcessBuoyancy", 0x5E1FA0, &CPed::ProcessBuoyancy);
    // Install("CPed", "PositionPedOutOfCollision", 0x5E0820, &CPed::PositionPedOutOfCollision);
    // Install("CPed", "GrantAmmo", 0x5DF220, &CPed::GrantAmmo);
    Install("CPed", "GetWeaponSlot", 0x5DF200, &CPed::GetWeaponSlot);
    // Install("CPed", "PositionAnyPedOutOfCollision", 0x5E13C0, &CPed::PositionAnyPedOutOfCollision);
    // Install("CPed", "CanBeDeletedEvenInVehicle", 0x5DF150, &CPed::CanBeDeletedEvenInVehicle);
    // Install("CPed", "CanBeDeleted", 0x5DF100, &CPed::CanBeDeleted);
    Install("CPed", "CanStrafeOrMouseControl", 0x5DF090, &CPed::CanStrafeOrMouseControl);
    Install("CPed", "CanBeArrested", 0x5DF060, &CPed::CanBeArrested);
    // Install("CPed", "CanSetPedState", 0x5DF030, &CPed::CanSetPedState);
    Install("CPed", "CanPedReturnToState", 0x5DF000, &CPed::CanPedReturnToState);
    // Install("CPed", "UseGroundColModel", 0x5DEFE0, &CPed::UseGroundColModel);
    ...
    // Install("CPed", "CreateDeadPedPickupCoors", 0x459180, &CPed::CreateDeadPedPickupCoors);
    // Install("CPed", "CreateDeadPedWeaponPickups", 0x4591D0, &CPed::CreateDeadPedWeaponPickups);
    // Install("CPed", "IsWearingGoggles", 0x479D10, &CPed::IsWearingGoggles);
    // Install("CPed", "SetAmmo", 0x5DF290, &CPed::SetAmmo);
    // Install("CPed", "SetStayInSamePlace", 0x481090, &CPed::SetStayInSamePlace);
    // Install("CPed", "SetPedStats", 0x5DEBC0, &CPed::SetPedStats);
    // Install("CPed", "SetMoveState", 0x5DEC00, &CPed::SetMoveState);
    // Install("CPed", "SetMoveAnimSpeed", 0x5DEC10, &CPed::SetMoveAnimSpeed);
    // Install("CPed", "StopNonPartialAnims", 0x5DED10, &CPed::StopNonPartialAnims);
    // Install("CPed", "RestartNonPartialAnims", 0x5DED50, &CPed::RestartNonPartialAnims);
    // Install("CPed", "DoWeHaveWeaponAvailable", 0x5DF300, &CPed::DoWeHaveWeaponAvailable);
    // Install("CPed", "RemoveGogglesModel", 0x5DF170, &CPed::RemoveGogglesModel);
    // Install("CPed", "SetGunFlashAlpha", 0x5DF400, &CPed::SetGunFlashAlpha);
    // Install("CPed", "CanSeeEntity", 0x5E0730, &CPed::CanSeeEntity);
    // Install("CPed", "SetPedDefaultDecisionMaker", 0x5E06E0, &CPed::SetPedDefaultDecisionMaker);
    // Install("CPed", "GetWalkAnimSpeed", 0x5E04B0, &CPed::GetWalkAnimSpeed);
    // Install("CPed", "StopPlayingHandSignal", 0x5E0480, &CPed::StopPlayingHandSignal);
    // Install("CPed", "IsPlayingHandSignal", 0x5E0460, &CPed::IsPlayingHandSignal);
    // Install("CPed", "CanThrowEntityThatThisPedIsHolding", 0x5E0400, &CPed::CanThrowEntityThatThisPedIsHolding);
    // Install("CPed", "DropEntityThatThisPedIsHolding", 0x5E0360, &CPed::DropEntityThatThisPedIsHolding);
    // Install("CPed", "GetEntityThatThisPedIsHolding", 0x5E02E0, &CPed::GetEntityThatThisPedIsHolding);
    // Install("CPed", "GetHoldingTask", 0x5E0290, &CPed::GetHoldingTask);
    // Install("CPed", "ReleaseCoverPoint", 0x5E0270, &CPed::ReleaseCoverPoint);
    // Install("CPed", "DoGunFlash", 0x5DF340, &CPed::DoGunFlash);
    // Install("CPed", "GetTransformedBonePosition", 0x5E01C0, &CPed::GetTransformedBonePosition);
    Install("CPed", "IsAlive", 0x5E0170, &CPed::IsAlive);
    // Install("CPed", "DeadPedMakesTyresBloody", 0x6B4200, &CPed::DeadPedMakesTyresBloody);
    // Install("CPed", "Undress", 0x5E00F0, &CPed::Undress);
    // Install("CPed", "SetLookTimer", 0x5DF8D0, &CPed::SetLookTimer);
    // Install("CPed", "RestoreHeadingRate", 0x5DFD60, &CPed::RestoreHeadingRate);
    // Install("CPed", "Dress", 0x5E0130, &CPed::Dress);
    Install("CPed", "IsPlayer", 0x5DF8F0, &CPed::IsPlayer);
    // Install("CPed", "GetBikeRidingSkill", 0x5DF510, &CPed::GetBikeRidingSkill);
    // Install("CPed", "SetPedPositionInCar", 0x5DF910, &CPed::SetPedPositionInCar);
    // Install("CPed", "SetRadioStation", 0x5DFD90, &CPed::SetRadioStation);
    // Install("CPed", "PositionAttachedPed", 0x5DFDF0, &CPed::PositionAttachedPed);
    // Install("CPed", "ResetGunFlashAlpha", 0x5DF4E0, &CPed::ResetGunFlashAlpha);

    // Virtual methods
    // Install("CPed", "SetModelIndex", 0x5E4880, &CPed::SetModelIndex_Reversed);
    // Install("CPed", "DeleteRwObject", 0x5DEBF0, &CPed::DeleteRwObject_Reversed);
    // Install("CPed", "ProcessControl", 0x5E8CD0, &CPed::ProcessControl_Reversed);
    // Install("CPed", "Teleport", 0x5E4110, &CPed::Teleport_Reversed);
    // Install("CPed", "SpecialEntityPreCollisionStuff", 0x5E3C30, &CPed::SpecialEntityPreCollisionStuff_Reversed);
    // Install("CPed", "SpecialEntityCalcCollisionSteps", 0x5E3E90, &CPed::SpecialEntityCalcCollisionSteps_Reversed);
    // Install("CPed", "PreRender", 0x5E8A20, &CPed::PreRender_Reversed);
    // Install("CPed", "Render", 0x5E7680, &CPed::Render_Reversed);
    // Install("CPed", "SetupLighting", 0x553F00, &CPed::SetupLighting_Reversed);
    // Install("CPed", "RemoveLighting", 0x5533B0, &CPed::RemoveLighting_Reversed);
    // Install("CPed", "FlagToDestroyWhenNextProcessed", 0x5E7B70, &CPed::FlagToDestroyWhenNextProcessed_Reversed);
    // Install("CPed", "ProcessEntityCollision", 0x5E2530, &CPed::ProcessEntityCollision_Reversed);
    // Install("CPed", "SetMoveAnim", 0x5E4A00, &CPed::SetMoveAnim_Reversed);
    // Install("CPed", "Save", 0x5D5730, &CPed::Save_Reversed);
    // Install("CPed", "Load", 0x5D4640, &CPed::Load_Reversed);
}
