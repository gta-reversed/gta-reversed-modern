...
// Converted from thiscall void CHeli::CHeli(int modelIndex,uint8_t createdBy) 0x6C4190
...
// Converted from cdecl void CHeli::AddHeliSearchLight(CVector const& origin,CVector const& target,float targetRadius,float power,uint32 coronaIndex,uint8_t unknownFlag,uint8_t drawShadow) 0x6C45B0
...
// Converted from cdecl void CHeli::SearchLightCone(int coronaIndex,CVector origin,CVector target,float targetRadius,float power,uint8_t unknownFlag,uint8_t drawShadow,CVector* ,CVector* ,CVector* ,bool,float baseRadius) 0x6C58E0
