...
{
    ReversibleHooks::Install(0x66F450, &CTaskComplexWander::Constructor);
    ReversibleHooks::Install(0x460CD0, &CTaskComplexWander::GetId_Reversed);
    ReversibleHooks::Install(0x674140, &CTaskComplexWander::CreateNextSubTask_Reversed);
    ReversibleHooks::Install(0x6740E0, &CTaskComplexWander::CreateFirstSubTask_Reversed);
    ReversibleHooks::Install(0x674C30, &CTaskComplexWander::ControlSubTask_Reversed);
    ReversibleHooks::Install(0x669DA0, &CTaskComplexWander::UpdateDir_Reversed);
    ReversibleHooks::Install(0x669ED0, &CTaskComplexWander::UpdatePathNodes_Reversed);
    ReversibleHooks::Install(0x671CB0, &CTaskComplexWander::CreateSubTask);
    ReversibleHooks::Install(0x669F60, &CTaskComplexWander::ComputeTargetPos);
    ReversibleHooks::Install(0x66F530, &CTaskComplexWander::ComputeTargetHeading);
    ReversibleHooks::Install(0x669F30, &CTaskComplexWander::ValidNodes);
    ReversibleHooks::Install(0x674560, &CTaskComplexWander::ScanForBlockedNodes);
    ReversibleHooks::Install(0x671EF0, (bool(CTaskComplexWander::*)(CPed*, CNodeAddress*))&CTaskComplexWander::ScanForBlockedNode);
    ReversibleHooks::Install(0x66F4C0, (bool(CTaskComplexWander::*)(CVector*, CEntity*))&CTaskComplexWander::ScanForBlockedNode);
    ReversibleHooks::Install(0x673D00, CTaskComplexWander::GetWanderTaskByPedType);
}
