...
{
    ReversibleHooks::Install(0x62F310, &CTaskSimpleStandStill::Constructor);
    ReversibleHooks::Install(0x635CF0, &CTaskSimpleStandStill::Clone_Reversed);
    ReversibleHooks::Install(0x4B8690, &CTaskSimpleStandStill::MakeAbortable_Reversed);
    ReversibleHooks::Install(0x62F370, &CTaskSimpleStandStill::ProcessPed_Reversed);
}
