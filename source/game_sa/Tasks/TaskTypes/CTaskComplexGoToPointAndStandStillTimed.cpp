...
{
    ReversibleHooks::Install(0x6685E0, &CTaskComplexGoToPointAndStandStillTimed::Constructor);
    ReversibleHooks::Install(0x66CF30, &CTaskComplexGoToPointAndStandStillTimed::Clone_Reversed);
    ReversibleHooks::Install(0x6686A0, &CTaskComplexGoToPointAndStandStillTimed::StopTimer_Reversed);
    ReversibleHooks::Install(0x668640, &CTaskComplexGoToPointAndStandStillTimed::MakeAbortable_Reversed);
    ReversibleHooks::Install(0x66DC90, &CTaskComplexGoToPointAndStandStillTimed::CreateFirstSubTask_Reversed);
    ReversibleHooks::Install(0x66DCE0, &CTaskComplexGoToPointAndStandStillTimed::ControlSubTask_Reversed);
}
