...
// 0x86DB24
constexpr auto STAND_STILL_TIME = 20000;
...
public:
    ...
    float m_radius{};
    uint8 m_shouldProcessStandStill : 1{true};
    uint8 m_hasAnim : 1{}; 
...
private:
    ...
    CTaskSimpleSlideToCoord* Constructor(CVector const& pos, float fAimingRotation, float radius) {
        this->CTaskSimpleSlideToCoord::CTaskSimpleSlideToCoord(pos, fAimingRotation, radius);
        return this;
    }

    CTaskSimpleSlideToCoord* Constructor(CVector const& pos, float aimRot, float radius, char const* animName, char const* fileName, int32 flags, float frameDelta, bool isActiveSequence, int32 time) {
        this->CTaskSimpleSlideToCoord::CTaskSimpleSlideToCoord(pos, aimRot, radius, animName, fileName, flags, frameDelta, isActiveSequence, time);
        return this;
    }

    CTaskSimpleSlideToCoord* Destructor() {
        this->CTaskSimpleSlideToCoord::~CTaskSimpleSlideToCoord();
        return this;
    }
