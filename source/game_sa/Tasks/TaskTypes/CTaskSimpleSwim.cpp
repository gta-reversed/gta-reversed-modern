...
void CTaskSimpleSwim::InjectHooks() {
    ReversibleHooks::Install(0x688930, &CTaskSimpleSwim::Constructor);
    ReversibleHooks::Install(0x68B050, &CTaskSimpleSwim::Clone_Reversed);
    ReversibleHooks::Install(0x6889F0, &CTaskSimpleSwim::GetId_Reversed);
    ReversibleHooks::Install(0x68B1C0, &CTaskSimpleSwim::ProcessPed_Reversed);
    ReversibleHooks::Install(0x68B100, &CTaskSimpleSwim::MakeAbortable_Reversed);
    ReversibleHooks::Install(0x68A8E0, &CTaskSimpleSwim::ApplyRollAndPitch);
    ReversibleHooks::Install(0x6899F0, &CTaskSimpleSwim::ProcessSwimAnims);
    ReversibleHooks::Install(0x68A1D0, &CTaskSimpleSwim::ProcessSwimmingResistance);
    ReversibleHooks::Install(0x68AA70, &CTaskSimpleSwim::ProcessEffects);
    ReversibleHooks::Install(0x689640, &CTaskSimpleSwim::ProcessControlAI);
    ReversibleHooks::Install(0x688A90, &CTaskSimpleSwim::ProcessControlInput);
    ReversibleHooks::Install(0x68A9F0, &CTaskSimpleSwim::CreateFxSystem);
    ReversibleHooks::Install(0x68AA50, &CTaskSimpleSwim::DestroyFxSystem);
}
