...
constexpr float MAX_STREAMING_RADIUS = 10000.0f;
constexpr float STREAMING_ANGLE_THRESHOLD = 20.62648f;
constexpr float MAX_BIGBUILDING_STREAMING_RADIUS = 80000.0f;
constexpr float BIGBUILDING_STREAMING_ANGLE_THRESHOLD = 40.107f;
