...
void CVisibilityPlugins::InjectHooks() {
    HookInstall(0x732170, &CVisibilityPlugins::AtomicCopyConstructor, 5);
    HookInstall(0x7321A0, &CVisibilityPlugins::AtomicDestructor, 5);
    HookInstall(0x732500, &CVisibilityPlugins::CalculateFadingAtomicAlpha, 5);
    HookInstall(0x732310, &CVisibilityPlugins::ClearAtomicFlag, 5);
    HookInstall(0x732330, &CVisibilityPlugins::ClearAtomicFlag, 5);
    HookInstall(0x732350, &CVisibilityPlugins::ClearClumpForAllAtomicsFlag, 5);
    HookInstall(0x732E10, &CVisibilityPlugins::ClumpConstructor, 5);
    HookInstall(0x732200, &CVisibilityPlugins::ClumpCopyConstructor, 5);
    HookInstall(0x732220, &CVisibilityPlugins::ClumpDestructor, 5);
    HookInstall(0x732A30, &CVisibilityPlugins::DefaultVisibilityCB, 5);
    HookInstall(0x7321B0, &CVisibilityPlugins::FrameConstructor, 5);
    HookInstall(0x7321D0, &CVisibilityPlugins::FrameCopyConstructor, 5);
    HookInstall(0x7321F0, &CVisibilityPlugins::FrameDestructor, 5);
    HookInstall(0x732A40, &CVisibilityPlugins::FrustumSphereCB, 5);
    HookInstall(0x732370, &CVisibilityPlugins::GetAtomicId, 5);
    HookInstall(0x732260, &CVisibilityPlugins::GetAtomicModelInfo, 5);
    HookInstall(0x732B20, &CVisibilityPlugins::GetClumpAlpha, 5);
    HookInstall(0x732AC0, &CVisibilityPlugins::GetClumpModelInfo, 5);
    HookInstall(0x732C80, (float(*)(RwFrame*)) & CVisibilityPlugins::GetDistanceSquaredFromCamera, 5);
    HookInstall(0x732CC0, (float(*)(CVector*)) & CVisibilityPlugins::GetDistanceSquaredFromCamera, 5);
    HookInstall(0x7326D0, &CVisibilityPlugins::GetDotProductWithCameraVector, 5);
    HookInstall(0x732A20, &CVisibilityPlugins::GetFrameHierarchyId, 5);
    HookInstall(0x732250, &CVisibilityPlugins::GetModelInfoIndex, 5);
    HookInstall(0x7323A0, &CVisibilityPlugins::GetUserValue, 5);
    HookInstall(0x734530, &CVisibilityPlugins::InitAlphaAtomicList, 5);
    HookInstall(0x734540, &CVisibilityPlugins::InitAlphaEntityList, 5);
    ...
    HookInstall(0x733A20, &CVisibilityPlugins::Initialise, 5);
    HookInstall(0x733E10, &CVisibilityPlugins::InsertAtomicIntoReallyDrawLastList, 5);
    HookInstall(0x733E50, &CVisibilityPlugins::InsertEntityIntoReallyDrawLastList, 5);
    HookInstall(0x734570, &CVisibilityPlugins::InsertEntityIntoSortedList, 5);
    HookInstall(0x732990, &CVisibilityPlugins::IsAtomicVisible, 5);
    HookInstall(0x732E30, &CVisibilityPlugins::PluginAttach, 5);
    HookInstall(0x732480, &CVisibilityPlugins::RenderAlphaAtomic, 5);
    HookInstall(0x733E90, &CVisibilityPlugins::RenderAlphaAtomics, 5);
    HookInstall(0x732660, &CVisibilityPlugins::RenderAtomicWithAlphaCB, 5);
    HookInstall(0x733EC0, &CVisibilityPlugins::RenderBoatAlphaAtomics, 5);
    HookInstall(0x732B40, &CVisibilityPlugins::RenderEntity, 5);
    HookInstall(0x732610, &CVisibilityPlugins::RenderFadingAtomic, 5);
    HookInstall(0x732680, &CVisibilityPlugins::RenderFadingClump, 5);
    HookInstall(0x733630, &CVisibilityPlugins::RenderFadingClumpCB, 5);
    HookInstall(0x733F10, &CVisibilityPlugins::RenderFadingEntities, 5);
    HookInstall(0x7337D0, &CVisibilityPlugins::RenderFadingUnderwaterEntities, 5);
    HookInstall(0x7340B0, &CVisibilityPlugins::RenderHeliRotorAlphaCB, 5);
    HookInstall(0x734170, &CVisibilityPlugins::RenderHeliTailRotorAlphaCB, 5);
    HookInstall(0x7323E0, &CVisibilityPlugins::RenderObjNormalAtomic, 5);
    HookInstall(0x7337A0, &CVisibilityPlugins::RenderOrderedList, 5);
    HookInstall(0x7335B0, &CVisibilityPlugins::RenderPedCB, 5);
    HookInstall(0x732870, &CVisibilityPlugins::RenderPlayerCB, 5);
    HookInstall(0x733800, &CVisibilityPlugins::RenderReallyDrawLastObjects, 5);
    HookInstall(0x734240, &CVisibilityPlugins::RenderTrainHiDetailAlphaCB, 5);
    HookInstall(0x733330, &CVisibilityPlugins::RenderTrainHiDetailCB, 5);
    HookInstall(0x733F80, &CVisibilityPlugins::RenderVehicleHiDetailAlphaCB, 5);
    HookInstall(0x734370, &CVisibilityPlugins::RenderVehicleHiDetailAlphaCB_BigVehicle, 5);
    HookInstall(0x7344A0, &CVisibilityPlugins::RenderVehicleHiDetailAlphaCB_Boat, 5);
    HookInstall(0x733240, &CVisibilityPlugins::RenderVehicleHiDetailCB, 5);
    HookInstall(0x733420, &CVisibilityPlugins::RenderVehicleHiDetailCB_BigVehicle, 5);
    HookInstall(0x733550, &CVisibilityPlugins::RenderVehicleHiDetailCB_Boat, 5);
    HookInstall(0x7334F0, &CVisibilityPlugins::RenderVehicleLoDetailCB_Boat, 5); 
    HookInstall(0x7331E0, &CVisibilityPlugins::RenderVehicleReallyLowDetailCB, 5);
    HookInstall(0x732820, &CVisibilityPlugins::RenderVehicleReallyLowDetailCB_BigVehicle, 5); 
    HookInstall(0x733670, &CVisibilityPlugins::RenderWeaponCB, 5);
    HookInstall(0x732F30, &CVisibilityPlugins::RenderWeaponPedsForPC, 5);
    HookInstall(0x7322D0, &CVisibilityPlugins::SetAtomicFlag, 5);
    HookInstall(0x7322B0, &CVisibilityPlugins::SetAtomicFlag, 5);
    HookInstall(0x732230, &CVisibilityPlugins::SetAtomicId, 5);
    HookInstall(0x7328A0, &CVisibilityPlugins::SetAtomicRenderCallback, 5);
    HookInstall(0x732B00, &CVisibilityPlugins::SetClumpAlpha, 5);
    HookInstall(0x733750, &CVisibilityPlugins::SetClumpModelInfo, 5);
    HookInstall(0x732A00, &CVisibilityPlugins::SetFrameHierarchyId, 5);
    HookInstall(0x7328C0, &CVisibilityPlugins::SetRenderWareCamera, 5);
    HookInstall(0x732380, &CVisibilityPlugins::SetUserValue, 5);
    HookInstall(0x733160, &CVisibilityPlugins::SetupVehicleVariables, 5);
    HookInstall(0x732EB0, &CVisibilityPlugins::Shutdown, 5);
    HookInstall(0x7336F0, &CVisibilityPlugins::VehicleVisibilityCB, 5);
    HookInstall(0x732AB0, &CVisibilityPlugins::VehicleVisibilityCB_BigVehicle, 5);
}
