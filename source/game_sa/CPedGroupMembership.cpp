...
void CPedGroupMembership::AddMember(CPed* member, int memberID) {
    plugin::CallMethod<0x5F6AE0, CPedGroupMembership*, CPed*, int>(this, member, memberID);
}
...
int CPedGroupMembership::CountMembers() {
    return plugin::CallMethodAndReturn<int, 0x5F6A50, CPedGroupMembership*>(this);
}

int CPedGroupMembership::CountMembersExcludingLeader() {
    return plugin::CallMethodAndReturn<int, 0x5F6AA0, CPedGroupMembership*>(this);
}
...
CPed* CPedGroupMembership::GetMember(int memberId) {
    return plugin::CallMethodAndReturn<CPed*, 0x5F69B0, CPedGroupMembership*, int>(this, memberId);
}
...
void CPedGroupMembership::RemoveMember(int memberID) {
    plugin::CallMethod<0x5F80D0, CPedGroupMembership*, int>(this, memberID);
}

char CPedGroupMembership::RemoveNFollowers(int count) {
    return plugin::CallMethodAndReturn<char, 0x5FB1D0, CPedGroupMembership*, int>(this, count);
}
