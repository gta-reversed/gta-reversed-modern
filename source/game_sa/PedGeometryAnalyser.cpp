...
//    Install("CPedGeometryAnalyser", "CanPedJumpObstacle", 0x0, &CPedGeometryAnalyser::CanPedJumpObstacle);
//    Install("CPedGeometryAnalyser", "CanPedJumpObstacle", 0x0, &CPedGeometryAnalyser::CanPedJumpObstacle);
//    Install("CPedGeometryAnalyser", "CanPedTargetPed", 0x5F1C40, &CPedGeometryAnalyser::CanPedTargetPed);
...
//    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxCentre", 0x0, &CPedGeometryAnalyser::ComputeEntityBoundingBoxCentre);
    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxCentreUncached", 0x5F1600, &CPedGeometryAnalyser::ComputeEntityBoundingBoxCentreUncached);
    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxCentreUncachedAll", 0x5F3B40, &CPedGeometryAnalyser::ComputeEntityBoundingBoxCentreUncachedAll);
//    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxCorners", 0x0, &CPedGeometryAnalyser::ComputeEntityBoundingBoxCorners);
//    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxCornersUncached", 0x5F1FA0, &CPedGeometryAnalyser::ComputeEntityBoundingBoxCornersUncached);
//    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxPlanes", 0x5F3660, &CPedGeometryAnalyser::ComputeEntityBoundingBoxPlanes);
    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxPlanesUncached", 0x5F1670, &CPedGeometryAnalyser::ComputeEntityBoundingBoxPlanesUncached);
//    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxPlanesUncachedAll", 0x0, &CPedGeometryAnalyser::ComputeEntityBoundingBoxPlanesUncachedAll);
//    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxSegmentPlanes", 0x0, &CPedGeometryAnalyser::ComputeEntityBoundingBoxSegmentPlanes);
//    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxSegmentPlanesUncached", 0x5F1750, &CPedGeometryAnalyser::ComputeEntityBoundingBoxSegmentPlanesUncached);
    Install("CPedGeometryAnalyser", "ComputeEntityBoundingBoxSegmentPlanesUncachedAll", 0x5F2BC0, &CPedGeometryAnalyser::ComputeEntityBoundingBoxSegmentPlanesUncachedAll);
...
//    Install("CPedGeometryAnalyser", "ComputeRouteRoundEntityBoundingBox", 0x0, &CPedGeometryAnalyser::ComputeRouteRoundEntityBoundingBox);
//    Install("CPedGeometryAnalyser", "ComputeRouteRoundEntityBoundingBox", 0x0, &CPedGeometryAnalyser::ComputeRouteRoundEntityBoundingBox);
//    Install("CPedGeometryAnalyser", "ComputeRouteRoundSphere", 0x5F1890, &CPedGeometryAnalyser::ComputeRouteRoundSphere);
//    Install("CPedGeometryAnalyser", "GetIsLineOfSightClear", 0x0, &CPedGeometryAnalyser::GetIsLineOfSightClear);
//    Install("CPedGeometryAnalyser", "GetIsLineOfSightClear", 0x0, &CPedGeometryAnalyser::GetIsLineOfSightClear);
//    Install("CPedGeometryAnalyser", "GetNearestPed", 0x5F3590, &CPedGeometryAnalyser::GetNearestPed);
//    Install("CPedGeometryAnalyser", "IsEntityBlockingTarget", 0x5F3970, &CPedGeometryAnalyser::IsEntityBlockingTarget);
//    Install("CPedGeometryAnalyser", "IsInAir", 0x5F1CB0, &CPedGeometryAnalyser::IsInAir);
//    Install("CPedGeometryAnalyser", "IsWanderPathClear", 0x5F2F70, &CPedGeometryAnalyser::IsWanderPathClear);
//    Install("CPedGeometryAnalyser", "LiesInsideBoundingBox", 0x5F3880, &CPedGeometryAnalyser::LiesInsideBoundingBox);
}
